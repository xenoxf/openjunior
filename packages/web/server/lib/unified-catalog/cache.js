 ...
 * Location: ~/.cache/glenker/catalog-cache.json
 */
...
function getCacheDir() {
  ...
  if (xdgCache) return path.join(xdgCache, 'glenker');
  if (process.platform === 'darwin') return path.join(os.homedir(), 'Library', 'Caches', 'glenker');
  return path.join(os.homedir(), '.cache', 'glenker');
}
