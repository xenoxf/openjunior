...
import openjunior_dark_Raw from './fields-of-the-shire-dark.json';
import openjunior_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  openjunior_dark_Raw as Theme,
  openjunior_light_Raw as Theme,
