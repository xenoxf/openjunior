...
import glenker_dark_Raw from './fields-of-the-shire-dark.json';
import glenker_light_Raw from './fields-of-the-shire-light.json';
...
export const presetThemes: Theme[] = [
  glenker_dark_Raw as Theme,
  glenker_light_Raw as Theme,
