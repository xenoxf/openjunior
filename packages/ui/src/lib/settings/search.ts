...
export const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.weekStartsOn',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.macVibrancy',
    descriptionKey: 'settings.openjunior.visual.field.macVibrancyHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.installAppName',
    descriptionKey: 'settings.openjunior.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.installOrientation',
    descriptionKey: 'settings.openjunior.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.openjunior.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.inputBarOffset',
    descriptionKey: 'settings.openjunior.visual.field.inputBarOffsetTooltip',
    keywords: ['input', 'home bar', 'offset'],
  },
  {
    id: 'appearance.expanded-editor-toolbar',
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.expandedEditorToolbar',
    keywords: ['editor', 'toolbar', 'tabs', 'docked', 'files'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.fileEditorKeymap',
  ...
  },
  {
    ...
    descriptionKey: 'settings.openjunior.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.openjunior.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.openjunior.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.reasoning-traces',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.collapsible-user-messages',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.openjunior.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.showDotfiles',
  ...
  },
  {
    id: 'chat.queue-mode',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.queueMessagesByDefault',
    descriptionKey: 'settings.openjunior.visual.field.queueMessagesByDefaultTooltip',
    keywords: ['queue', 'enter', 'send'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.openjunior.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.openjunior.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.openjunior.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.openjunior.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.openjunior.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.openjunior.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.openjunior.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.openjunior.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.openjunior.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'sessions',
    titleKey: 'settings.openjunior.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.openjunior.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.openjunior.desktopPassword.field.password',
    descriptionKey: 'settings.openjunior.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.openjunior.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.openjunior.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.openjunior.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.openjunior.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.openjunior.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.openjunior.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.openjunior.git.showGitignored',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.openjunior.keyboardShortcuts.title',
    descriptionKey: 'settings.openjunior.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.openjunior.tunnel.field.provider',
    descriptionKey: 'settings.openjunior.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.openjunior.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.openjunior.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.openjunior.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.openjunior.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.openjunior.tunnel.field.configurationFile',
    descriptionKey: 'settings.openjunior.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.openjunior.tunnel.actions.startTunnel',
    descriptionKey: 'settings.openjunior.tunnel.note.connectLinksOneTime',
