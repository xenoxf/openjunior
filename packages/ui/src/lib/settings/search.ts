...
export const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.weekStartsOn',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.macVibrancy',
    descriptionKey: 'settings.glenker.visual.field.macVibrancyHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.installAppName',
    descriptionKey: 'settings.glenker.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.installOrientation',
    descriptionKey: 'settings.glenker.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.glenker.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.terminalFontSize',
    keywords: ['terminal', 'font', 'text size'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.inputBarOffset',
    descriptionKey: 'settings.glenker.visual.field.inputBarOffsetTooltip',
    keywords: ['input', 'home bar', 'offset'],
  },
  {
    id: 'appearance.expanded-editor-toolbar',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.expandedEditorToolbar',
    keywords: ['editor', 'toolbar', 'tabs', 'docked', 'files'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.show-terminal-button',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.showTerminalButton',
    keywords: ['terminal', 'button', 'panel', 'toggle'],
  },
  {
    id: 'appearance.show-mini-browser',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.showMiniBrowser',
    keywords: ['browser', 'mini browser', 'context panel', 'webview'],
  },
  {
    id: 'appearance.show-mini-chat',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.showMiniChat',
    keywords: ['mini chat', 'picture in picture', 'pip', 'floating chat'],
  },
  {
    id: 'appearance.show-right-sidebar',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.showRightSidebar',
    keywords: ['sidebar', 'right sidebar', 'git', 'files', 'context'],
  },
  {
    id: 'appearance.terminal-quick-keys',
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.glenker.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.glenker.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.glenker.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.glenker.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'chat',
    titleKey: 'settings.glenker.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.reasoning-traces',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.collapsible-user-messages',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.glenker.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.showDotfiles',
  ...
  },
  {
    id: 'chat.queue-mode',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.queueMessagesByDefault',
    descriptionKey: 'settings.glenker.visual.field.queueMessagesByDefaultTooltip',
    keywords: ['queue', 'enter', 'send'],
  },
  {
    id: 'chat.persist-drafts',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.glenker.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.glenker.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.glenker.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.glenker.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.glenker.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.glenker.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.glenker.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.glenker.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.glenker.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'sessions',
    titleKey: 'settings.glenker.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.glenker.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.glenker.desktopPassword.field.password',
    descriptionKey: 'settings.glenker.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.glenker.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.glenker.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.glenker.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'sessions',
    titleKey: 'settings.glenker.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.glenker.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.glenker.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.glenker.git.showGitignored',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.glenker.keyboardShortcuts.title',
    descriptionKey: 'settings.glenker.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.glenker.tunnel.field.provider',
    descriptionKey: 'settings.glenker.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.glenker.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.glenker.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.glenker.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.glenker.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.glenker.tunnel.field.configurationFile',
    descriptionKey: 'settings.glenker.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.glenker.tunnel.actions.startTunnel',
    descriptionKey: 'settings.glenker.tunnel.note.connectLinksOneTime',
