...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install OpenJunior for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'OpenJunior installed',
  ...
  'sessions.sidebar.footer.actions.aboutOpenJunior': 'About OpenJunior',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to OpenJunior — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop OpenJunior',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpenJunior version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OpenJunior state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate OpenJunior efficiently',
  ...
  'header.actions.openAppMenu': 'OpenJunior menu',
  'header.actions.openAppMenuAria': 'Open OpenJunior menu',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock OpenJunior',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote OpenJunior servers',
  ...
  'multiRun.window.description': 'OpenJunior Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to OpenJunior',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OpenJunior does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of OpenJunior — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OpenJunior settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an OpenJunior server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an OpenJunior server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different OpenJunior version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running OpenJunior but is not compatible with this app version. Update OpenJunior on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running OpenJunior. Verify the address points to an OpenJunior server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running OpenJunior. Verify the address points to an OpenJunior server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The OpenJunior server at "{host}" is not compatible with this app version. Update OpenJunior on the server, then try again.',
  ...
  'startup.initRecovery.description': 'OpenJunior could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating OpenJunior...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep OpenJunior open.',
  ...
  'setupWizard.title': 'Welcome to OpenJunior',
  ...
  'openChamberLogo.aria.logo': 'OpenJunior logo',
