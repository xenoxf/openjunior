...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install Glenker for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'Glenker installed',
  ...
  'sessions.sidebar.footer.actions.aboutGlenker': 'About Glenker',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to Glenker — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'header.services.shutdownDev': 'Stop Glenker',
  ...
  'aboutDialog.glenkerVersionLabel': 'Glenker version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes Glenker state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate Glenker efficiently',
  ...
  'header.actions.openAppMenu': 'Glenker menu',
  'header.actions.openAppMenuAria': 'Open Glenker menu',
  ...
  'chat.commandAutocomplete.command.goalDescription': 'Set a goal that the AI will keep top-of-mind for all subsequent work.',
  ...
  'chat.chatInput.toast.goalCleared': 'Goal cleared',
  'chat.chatInput.toast.goalNone': 'No active goal. Set one with /goal <your objective>',
  'chat.chatInput.toast.goalFailed': 'Failed to set goal',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock Glenker',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote Glenker servers',
  ...
  'multiRun.window.description': 'Glenker Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to Glenker',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If Glenker does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of Glenker — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to Glenker settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an Glenker server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an Glenker server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different Glenker version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running Glenker but is not compatible with this app version. Update Glenker on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running Glenker. Verify the address points to an Glenker server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running Glenker. Verify the address points to an Glenker server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The Glenker server at "{host}" is not compatible with this app version. Update Glenker on the server, then try again.',
  ...
  'startup.initRecovery.description': 'Glenker could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating Glenker...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: glenker update',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep Glenker open.',
  ...
  'setupWizard.title': 'Welcome to Glenker',
  'setupWizard.subtitle': 'Let\'s get you set up in a few steps',
  'setupWizard.skip': 'Skip',
  'setupWizard.back': 'Back',
  'setupWizard.next': 'Next',
  'setupWizard.finish': 'Finish',
  'setupWizard.step1.title': 'What do you want to do?',
  'setupWizard.step1.subtitle': 'Choose your main use case so we can configure the best experience for you',
  'setupWizard.useCase.coding': 'Write & Debug Code',
  'setupWizard.useCase.codingDesc': 'Full coding assistant with file editing, terminal, and git',
  'setupWizard.useCase.writing': 'Write & Document',
  'setupWizard.useCase.writingDesc': 'Writing assistant for docs, blogs, and technical content',
  'setupWizard.useCase.research': 'Research & Learn',
  'setupWizard.useCase.researchDesc': 'Web search, code exploration, and deep analysis',
  'setupWizard.useCase.automation': 'Automate Tasks',
  'setupWizard.useCase.automationDesc': 'Run scripts, manage workflows, and automate repetitive work',
  'setupWizard.step2.title': 'Connect Your AI',
  'setupWizard.step2.subtitle': 'Choose an AI provider to power your conversations',
  'setupWizard.step2.apiKey': 'API Key',
  'setupWizard.step2.apiKeyHint': 'Your key is stored locally and never shared',
  'setupWizard.step2.apiKeyPlaceholder': 'Enter your API key',
  'setupWizard.step2.localInfo': 'Local models run on your machine via Ollama. Configure in Settings → Providers.',
  'setupWizard.step3.title': 'Choose Your Profile',
  'setupWizard.step3.subtitle': 'Pick a preset that matches how you work',
  'setupWizard.step3.ready': 'You\'re all set! Click Finish to start.',
  'setupWizard.profile.developer': 'Developer',
  'setupWizard.profile.developerDesc': 'Best for coding, debugging, and software development',
  'setupWizard.profile.writer': 'Writer',
  'setupWizard.profile.writerDesc': 'Best for documentation, blogs, and technical writing',
  'setupWizard.profile.researcher': 'Researcher',
  'setupWizard.profile.researcherDesc': 'Best for deep research, code exploration, and learning',
  'setupWizard.profile.student': 'Student',
  'setupWizard.profile.studentDesc': 'Best for learning, tutoring, and guided problem solving',
  ...
  'glenkerLogo.aria.logo': 'Glenker logo',
