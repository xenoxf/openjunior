...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj OpenJunior, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'OpenJunior został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutOpenJunior': 'O OpenJunior',
  ...
  'chat.commandAutocomplete.command.goalDescription': 'Ustaw cel, który AI będzie miała na uwadze podczas wszystkich kolejnych prac.',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia OpenJunior.',
  ...
  'onboarding.chooser.title': 'Witaj w OpenJunior',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OpenJunior nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OpenJunior i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera OpenJunior aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer OpenJunior, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji OpenJunior. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia OpenJunior, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpenJunior na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim OpenJunior. Zweryfikuj czy adres wskazuje na serwer OpenJunior.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia OpenJunior. Zweryfikuj czy adres wskazuje na serwer OpenJunior.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer OpenJunior pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpenJunior na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'OpenJunior nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OpenJunior, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja OpenJunior {version}',
  ...
  'chat.chatInput.toast.goalCleared': 'Cel wyczyszczony',
  'chat.chatInput.toast.goalNone': 'Brak aktywnego celu. Ustaw jeden za pomocą /goal <twój cel>',
  'chat.chatInput.toast.goalFailed': 'Nie udało się ustawić celu',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do OpenJunior — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami OpenJunior',
  ...
  'header.actions.openAppMenu': 'Menu OpenJunior',
  'header.actions.openAppMenuAria': 'Otwórz menu OpenJunior',
  ...
  'header.services.shutdownDev': 'Zatrzymaj OpenJunior',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po OpenJunior.',
  ...
  'openChamberLogo.aria.logo': 'Logo OpenJunior',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj OpenJunior',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: openjunior update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie OpenJunior...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw OpenJunior otwarte.',
  ...
  'openjuniorUpdate.toast.available.title': 'OpenJunior update',
  'openjuniorUpdate.toast.available.description': 'Version {version} available.',
  'openjuniorUpdate.toast.actions.download': 'Download',
  'openjuniorUpdate.toast.actions.restart': 'Restart',
  'openjuniorUpdate.toast.actions.dismiss': 'Dismiss',
  'openjuniorUpdate.toast.downloading.title': 'Downloading update...',
  'openjuniorUpdate.toast.downloading.description': '{progress}% complete',
  'openjuniorUpdate.toast.downloaded.title': 'Update downloaded',
  'openjuniorUpdate.toast.downloaded.description': 'Restart to apply version {version}',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce OpenJunior — zainstaluj je, aby zacząć.',
  ...
  'settings.openjunior.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.openjunior.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.openjunior.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.openjunior.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.openjunior.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.openjunior.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.openjunior.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.openjunior.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
  ...
  'setupWizard.title': 'Witaj w OpenJunior',
  'setupWizard.subtitle': 'Skonfigurujemy Cię w kilku krokach',
  'setupWizard.skip': 'Pomiń',
  'setupWizard.back': 'Wstecz',
  'setupWizard.next': 'Dalej',
  'setupWizard.finish': 'Zakończ',
  'setupWizard.step1.title': 'Co chcesz robić?',
  'setupWizard.step1.subtitle': 'Wybierz główny przypadek użycia, abyśmy mogli skonfigurować najlepsze doświadczenie',
  'setupWizard.useCase.coding': 'Pisanie i debugowanie kodu',
  'setupWizard.useCase.codingDesc': 'W pełni funkcjonalny asystent programowania z edycją plików, terminalem i git',
  'setupWizard.useCase.writing': 'Pisanie i dokumentacja',
  'setupWizard.useCase.writingDesc': 'Asystent pisarski do dokumentacji, blogów i treści technicznych',
  'setupWizard.useCase.research': 'Badania i nauka',
  'setupWizard.useCase.researchDesc': 'Przeszukiwanie sieci, eksploracja kodu i głęboka analiza',
  'setupWizard.useCase.automation': 'Automatyzacja zadań',
  'setupWizard.useCase.automationDesc': 'Uruchamianie skryptów, zarządzanie przepływami pracy i automatyzacja powtarzalnych zadań',
  'setupWizard.step2.title': 'Połącz swoje AI',
  'setupWizard.step2.subtitle': 'Wybierz dostawcę AI, który będzie obsługiwał Twoje rozmowy',
  'setupWizard.step2.apiKey': 'Klucz API',
  'setupWizard.step2.apiKeyHint': 'Twój klucz jest przechowywany lokalnie i nigdy nie jest udostępniany',
  'setupWizard.step2.apiKeyPlaceholder': 'Wpisz swój klucz API',
  'setupWizard.step2.localInfo': 'Modele lokalne działają na Twojej maszynie przez Ollama. Skonfiguruj w Ustawieniach → Dostawcy.',
  'setupWizard.step3.title': 'Wybierz swój profil',
  'setupWizard.step3.subtitle': 'Wybierz predefiniowane ustawienia pasujące do Twojej pracy',
  'setupWizard.step3.ready': 'Wszystko gotowe! Kliknij Zakończ, by zacząć.',
  'setupWizard.profile.developer': 'Programista',
  'setupWizard.profile.developerDesc': 'Najlepsze do kodowania, debugowania i rozwoju oprogramowania',
  'setupWizard.profile.writer': 'Pisarz',
  'setupWizard.profile.writerDesc': 'Najlepsze do dokumentacji, blogów i pisania technicznego',
  'setupWizard.profile.researcher': 'Badacz',
  'setupWizard.profile.researcherDesc': 'Najlepsze do głębokich badań, eksploracji kodu i nauki',
  'setupWizard.profile.student': 'Student',
  'setupWizard.profile.studentDesc': 'Najlepsze do nauki, nauczania i prowadzonego rozwiązywania problemów',
  'settings.integrations.page.title': 'Integracje',
  'settings.integrations.page.subtitle.available': '{count} dostępnych',
  'settings.integrations.page.subtitle.sourcesOnline': '{count} źródeł online',
  'settings.integrations.page.subtitle.cached': '{count} w pamięci podręcznej',
  'settings.integrations.page.searchPlaceholder': 'Szukaj integracji...',
  'settings.integrations.page.filterAll': 'Wszystkie',
  'settings.integrations.page.filterSkills': 'Umiejętności',
  'settings.integrations.page.filterMCPs': 'MCP',
  'settings.integrations.page.filterPlugins': 'Wtyczki',
  'settings.integrations.page.categoryAll': 'Wszystkie kategorie',
  'settings.integrations.page.categoryFiles': 'Pliki i dane',
  'settings.integrations.page.categoryTools': 'Narzędzia',
  'settings.integrations.page.categoryChat': 'Czat i głos',
  'settings.integrations.page.categoryAgents': 'Agenci',
  'settings.integrations.page.categoryServices': 'Usługi',
  'settings.integrations.page.loading': 'Ładowanie integracji...',
  'settings.integrations.page.empty': 'Nie znaleziono integracji',
  'settings.integrations.page.emptyHint': 'Spróbuj innego wyszukiwania lub filtra',
  'settings.integrations.card.skill': 'Umiejętność',
  'settings.integrations.card.mcp': 'MCP',
  'settings.integrations.card.plugin': 'Wtyczka',
  'settings.integrations.card.official': 'Oficjalna',
  'settings.integrations.card.installed': 'Zainstalowana',
  'settings.integrations.detail.about': 'O programie',
  'settings.integrations.detail.howToInstall': 'Jak zainstalować',
  'settings.integrations.detail.requiredCredentials': 'Wymagane dane uwierzytelniające',
  'settings.integrations.detail.required': 'Wymagane',
  'settings.integrations.detail.details': 'Szczegóły',
  'settings.integrations.detail.source': 'Źródło',
  'settings.integrations.detail.author': 'Autor',
  'settings.integrations.detail.version': 'Wersja',
  'settings.integrations.detail.category': 'Kategoria',
  'settings.integrations.detail.tags': 'Tagi',
  'settings.integrations.detail.documentation': 'Dokumentacja',
  'settings.integrations.detail.install': 'Zainstaluj',
