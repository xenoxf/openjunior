...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj Glenker, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'Glenker został zainstalowany',
  ...
  'sessions.sidebar.footer.actions.aboutGlenker': 'O Glenker',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia Glenker.',
  ...
  'onboarding.chooser.title': 'Witaj w Glenker',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli Glenker nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień Glenker i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera Glenker aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer Glenker, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji Glenker. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia Glenker, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj Glenker na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim Glenker. Zweryfikuj czy adres wskazuje na serwer Glenker.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia Glenker. Zweryfikuj czy adres wskazuje na serwer Glenker.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer Glenker pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj Glenker na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'Glenker nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan Glenker, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.glenkerVersionLabel': 'Wersja Glenker {version}',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do Glenker — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami Glenker',
  ...
  'header.actions.openAppMenu': 'Menu Glenker',
  'header.actions.openAppMenuAria': 'Otwórz menu Glenker',
  ...
  'header.services.shutdownDev': 'Zatrzymaj Glenker',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po Glenker.',
  ...
  'glenkerLogo.aria.logo': 'Logo Glenker',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj Glenker',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: glenker update',
  ...
  'updateDialog.header.updating': 'Aktualizowanie Glenker...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw Glenker otwarte.',
  ...
  'glenkerUpdate.toast.available.title': 'Glenker update',
  'glenkerUpdate.toast.available.description': 'Version {version} available.',
  'glenkerUpdate.toast.actions.download': 'Download',
  'glenkerUpdate.toast.actions.restart': 'Restart',
  'glenkerUpdate.toast.actions.dismiss': 'Dismiss',
  'glenkerUpdate.toast.downloading.title': 'Downloading update...',
  'glenkerUpdate.toast.downloading.description': '{progress}% complete',
  'glenkerUpdate.toast.downloaded.title': 'Update downloaded',
  'glenkerUpdate.toast.downloaded.description': 'Restart to apply version {version}',
  'glenkerUpdate.toast.failed.title': 'Update failed',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce Glenker — zainstaluj je, aby zacząć.',
  ...
  'settings.glenker.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.glenker.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.glenker.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.glenker.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.glenker.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.glenker.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.glenker.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.glenker.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
  ...
  'setupWizard.title': 'Witaj w Glenker',
