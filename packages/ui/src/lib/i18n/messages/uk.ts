...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Установіть Glenker для швидшого доступу",
  "pwa.installPrompt.action": "Установити",
  "pwa.installPrompt.dismiss": "Сховати",
  "pwa.installPrompt.started": "Установлення розпочато",
  "pwa.installPrompt.installed": "Glenker встановлено",
  ...
  "sessions.sidebar.footer.actions.aboutGlenker": "Про Glenker",
  ...
  "contextPanel.browser.trustNotice": "Сторінки, відкриті тут, працюють із повним доступом до Glenker — це потрібно для inspect і скріншотів. Відкривайте лише сайти, яким довіряєте: шкідлива сторінка може прочитати ваші дані чи діяти від вашого імені.",
  ...
  "header.services.shutdownDev": "Зупинити Glenker",
  ...
  "aboutDialog.glenkerVersionLabel": "Версія Glenker {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Містить стан Glenker, стан OpenCode, каталоги та проєкти.",
  ...
  "helpDialog.description": "Використовуйте ці комбінації клавіш для ефективної навігації Glenker",
  ...
  "header.actions.openAppMenu": "Меню Glenker",
  "header.actions.openAppMenuAria": "Відкрити меню Glenker",
  ...
  "chat.commandAutocomplete.command.goalDescription": "Встановіть ціль, яку AI пам'ятатиме протягом усієї подальшої роботи.",
  ...
  "chat.chatInput.toast.goalCleared": "Ціль видалено",
  "chat.chatInput.toast.goalNone": "Немає активної цілі. Встановіть її за допомогою /goal <ваша ціль>",
  "chat.chatInput.toast.goalFailed": "Не вдалося встановити ціль",
  ...
  "sessionAuth.locked.unlockTitle": "Розблокувати Glenker",
  ...
  "desktopHostSwitcher.description": "Перемикання між Local і віддаленими Glenker серверами",
  ...
  "multiRun.window.description": "Вікно мультизапуску Glenker.",
  ...
  "onboarding.chooser.title": "Ласкаво просимо до Glenker",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Якщо Glenker не визначає OpenCode автоматично, укажіть шлях до виконуваного файла нижче.",
  "onboarding.localSetup.intro": "OpenCode — серце Glenker. Встановіть його, щоб почати.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Зберігає налаштування в Glenker і перезавантажує конфігурацію OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Введіть адресу сервера Glenker для підключення.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Пропозиції: переконайтеся, що URL вказує на сервер Glenker або зверніться до адміністратора сервера.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Цей інстанс працює з іншою версією Glenker. Можна підключитися, але оновіть обидва застосунки, якщо щось не працюватиме.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "Сервер працює з Glenker, але несумісний із цією версією застосунку. Оновіть Glenker на сервері та повторіть спробу.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "Сервер відповів, але не працює Glenker. Перевірте, чи адреса вказує на сервер Glenker.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "На сервері \"{host}\" не запущено Glenker. Перевірте, чи адреса вказує на сервер Glenker.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Потрібне оновлення сервера",
  "onboarding.desktopRecovery.remoteIncompatible.description": "Сервер Glenker на \"{host}\" несумісний із цією версією застосунку. Оновіть Glenker на сервері та повторіть спробу.",
  ...
  "startup.initRecovery.description": "Glenker не зміг завершити ініціалізацію. Перевірте, що сервер запущений, і повторіть спробу.",
  ...
  "updateDialog.header.updating": "Оновлення Glenker...",
  ...
  "updateDialog.error.takingLonger": "Оновлення триває довше, ніж очікувалося. Зачекайте трохи та оновіть або запустіть: glenker update",
  ...
  "opencodeUpdate.toast.upgrading.description": "Залиште Glenker відкритим.",
  ...
  "glenkerLogo.aria.logo": "Логотип Glenker",
  ...
  "setupWizard.title": "Ласкаво просимо до Glenker",
  "setupWizard.subtitle": "Налаштуємо вас за декілька кроків",
  "setupWizard.skip": "Пропустити",
  "setupWizard.back": "Назад",
  "setupWizard.next": "Далі",
  "setupWizard.finish": "Завершити",
  "setupWizard.step1.title": "Що ви хочете робити?",
  "setupWizard.step1.subtitle": "Оберіть основний сценарій використання, щоб ми налаштували найкращий досвід",
  "setupWizard.useCase.coding": "Написання та відладка коду",
  "setupWizard.useCase.codingDesc": "Повний асистент для кодування з редагуванням файлів, терміналом та git",
  "setupWizard.useCase.writing": "Написання та документування",
  "setupWizard.useCase.writingDesc": "Асистент для написання документів, блогів та технічного контенту",
  "setupWizard.useCase.research": "Дослідження та навчання",
  "setupWizard.useCase.researchDesc": "Веб-пошук, дослідження коду та глибокий аналіз",
  "setupWizard.useCase.automation": "Автоматизація задач",
  "setupWizard.useCase.automationDesc": "Запуск скриптів, керування робочими процесами та автоматизація рутинної роботи",
  "setupWizard.step2.title": "Підключіть ваш штучний інтелект",
  "setupWizard.step2.subtitle": "Оберіть постачальника ШІ для спілкування",
  "setupWizard.step2.apiKey": "API Key",
  "setupWizard.step2.apiKeyHint": "Ваш ключ зберігається локально і ніколи не передається",
  "setupWizard.step2.apiKeyPlaceholder": "Введіть ваш API ключ",
  "setupWizard.step2.localInfo": "Локальні моделі працюють на вашій машині через Ollama. Налаштуйте в Налаштуваннях → Провайдери.",
  "setupWizard.step3.title": "Оберіть свій профіль",
  "setupWizard.step3.subtitle": "Виберіть пресет, що відповідає вашому стилю роботи",
  "setupWizard.step3.ready": "Все готово! Натисніть Завершити, щоб почати.",
  "setupWizard.profile.developer": "Розробник",
  "setupWizard.profile.developerDesc": "Ідеально для програмування, відлагодження та розробки ПЗ",
  "setupWizard.profile.writer": "Письменник",
  "setupWizard.profile.writerDesc": "Ідеально для документації, блогів та технічного написання",
  "setupWizard.profile.researcher": "Дослідник",
  "setupWizard.profile.researcherDesc": "Ідеально для глибокого дослідження, дослідження коду та навчання",
  "setupWizard.profile.student": "Студент",
  "setupWizard.profile.studentDesc": "Ідеально для навчання, репетиторства та керівницького вирішення проблем",
  "settings.integrations.page.title": "Інтеграції",
  "settings.integrations.page.subtitle.available": "{count} доступних",
  "settings.integrations.page.subtitle.sourcesOnline": "{count} джерел онлайн",
  "settings.integrations.page.subtitle.cached": "{count} у кеші",
  "settings.integrations.page.searchPlaceholder": "Пошук інтеграцій...",
  "settings.integrations.page.filterAll": "Усі",
  "settings.integrations.page.filterSkills": "Навички",
  "settings.integrations.page.filterMCPs": "MCP",
  "settings.integrations.page.filterPlugins": "Плагіни",
  "settings.integrations.page.categoryAll": "Усі категорії",
  "settings.integrations.page.categoryFiles": "Файли та дані",
  "settings.integrations.page.categoryTools": "Інструменти",
  "settings.integrations.page.categoryChat": "Чат та голос",
  "settings.integrations.page.categoryAgents": "Агенти",
  "settings.integrations.page.categoryServices": "Сервіси",
  "settings.integrations.page.loading": "Завантаження інтеграцій...",
  "settings.integrations.page.empty": "Інтеграції не знайдено",
  "settings.integrations.page.emptyHint": "Спробуйте інший пошук або фільтр",
  "settings.integrations.card.skill": "Навичка",
  "settings.integrations.card.mcp": "MCP",
  "settings.integrations.card.plugin": "Плагін",
  "settings.integrations.card.official": "Офіційний",
  "settings.integrations.card.installed": "Встановлено",
  "settings.integrations.detail.about": "Про",
  "settings.integrations.detail.howToInstall": "Як встановити",
  "settings.integrations.detail.requiredCredentials": "Потрібні облікові дані",
  "settings.integrations.detail.required": "Обов'язково",
  "settings.integrations.detail.details": "Деталі",
  "settings.integrations.detail.source": "Джерело",
  "settings.integrations.detail.author": "Автор",
  "settings.integrations.detail.version": "Версія",
  "settings.integrations.detail.category": "Категорія",
  "settings.integrations.detail.tags": "Теги",
  "settings.integrations.detail.documentation": "Документація",
  "settings.integrations.detail.install": "Встановити",
