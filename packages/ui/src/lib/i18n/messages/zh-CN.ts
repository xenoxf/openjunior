...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 Glenker 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'Glenker 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutGlenker': '关于 Glenker',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 Glenker 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Glenker 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 Glenker',
  ...
  'header.actions.openAppMenu': 'Glenker 菜单',
  'header.actions.openAppMenuAria': '打开 Glenker 菜单',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 Glenker',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 Glenker 服务器之间切换',
  ...
  'multiRun.window.description': 'Glenker 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 Glenker',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Glenker 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 Glenker 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 Glenker 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 Glenker 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 Glenker 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 Glenker。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 Glenker，但与此应用版本不兼容。请更新服务器上的 Glenker 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 Glenker。请确认地址是否指向 Glenker 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 Glenker。请确认地址是否指向 Glenker 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 Glenker 服务器与此应用版本不兼容。请更新服务器上的 Glenker 后重试。',
  ...
  'startup.initRecovery.description': 'Glenker 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等后刷新，或运行：glenker update',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 Glenker 打开。',
  ...
  'glenkerLogo.aria.logo': 'Glenker 标志',
  ...
  'setupWizard.title': '欢迎使用 Glenker',
