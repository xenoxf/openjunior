...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安装 OpenJunior 以便更快访问',
  'pwa.installPrompt.action': '安装',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已开始安装',
  'pwa.installPrompt.installed': 'OpenJunior 已安装',
  ...
  'sessions.sidebar.footer.actions.aboutOpenJunior': '关于 OpenJunior',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 OpenJunior 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenJunior 状态、OpenCode 健康信息、目录和项目。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 OpenJunior',
  ...
  'header.actions.openAppMenu': 'OpenJunior 菜单',
  'header.actions.openAppMenuAria': '打开 OpenJunior 菜单',
  ...
  'chat.commandAutocomplete.command.goalDescription': '设定一个目标，AI 将在所有后续工作中牢记该目标。',
  ...
  'chat.chatInput.toast.goalCleared': '目标已清除',
  'chat.chatInput.toast.goalNone': '没有活动目标。使用 /goal <你的目标> 设置一个',
  'chat.chatInput.toast.goalFailed': '设置目标失败',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 OpenJunior',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 OpenJunior 服务器之间切换',
  ...
  'multiRun.window.description': 'OpenJunior 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 OpenJunior',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenJunior 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 OpenJunior 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OpenJunior 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 OpenJunior 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 OpenJunior 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 OpenJunior。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 OpenJunior，但与此应用版本不兼容。请更新服务器上的 OpenJunior 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 OpenJunior。请确认地址是否指向 OpenJunior 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 OpenJunior。请确认地址是否指向 OpenJunior 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 OpenJunior 服务器与此应用版本不兼容。请更新服务器上的 OpenJunior 后重试。',
  ...
  'startup.initRecovery.description': 'OpenJunior 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 OpenJunior 打开。',
  ...
  'openChamberLogo.aria.logo': 'OpenJunior 标志',
  ...
  'setupWizard.title': '欢迎使用 OpenJunior',
  'setupWizard.subtitle': '让我们在几步内为您完成设置',
  'setupWizard.skip': '跳过',
  'setupWizard.back': '返回',
  'setupWizard.next': '下一步',
  'setupWizard.finish': '完成',
  'setupWizard.step1.title': '您想做什么？',
  'setupWizard.step1.subtitle': '选择您的主要用例，以便我们为您配置最佳体验',
  'setupWizard.useCase.coding': '编写和调试代码',
  'setupWizard.useCase.codingDesc': '功能完整的编程助手，支持文件编辑、终端和 git',
  'setupWizard.useCase.writing': '写作和文档',
  'setupWizard.useCase.writingDesc': '用于文档、博客和技术内容的写作助手',
  'setupWizard.useCase.research': '研究和学习',
  'setupWizard.useCase.researchDesc': '网络搜索、代码探索和深度分析',
  'setupWizard.useCase.automation': '自动化任务',
  'setupWizard.useCase.automationDesc': '运行脚本、管理工作流和自动化重复性工作',
  'setupWizard.step2.title': '连接您的 AI',
  'setupWizard.step2.subtitle': '选择一个 AI 提供商来支持您的对话',
  'setupWizard.step2.apiKey': 'API Key',
  'setupWizard.step2.apiKeyHint': '您的密钥仅在本地存储，绝不共享',
  'setupWizard.step2.apiKeyPlaceholder': '输入您的 API key',
  'setupWizard.step2.localInfo': '本地模型通过 Ollama 在您的机器上运行。在设置 → 供应商中配置。',
  'setupWizard.step3.title': '选择您的配置文件',
  'setupWizard.step3.subtitle': '选择一个预设，匹配您的工作方式',
  'setupWizard.step3.ready': '一切就绪！点击完成开始。',
  'setupWizard.profile.developer': '开发者',
  'setupWizard.profile.developerDesc': '最适合编码、调试和软件开发',
  'setupWizard.profile.writer': '作家',
  'setupWizard.profile.writerDesc': '最适合文档、博客和技术写作',
  'setupWizard.profile.researcher': '研究员',
  'setupWizard.profile.researcherDesc': '最适合深度研究、代码探索和学习',
  'setupWizard.profile.student': '学生',
  'setupWizard.profile.studentDesc': '最适合学习、辅导和引导式问题解决',
  'settings.integrations.page.title': '集成',
  'settings.integrations.page.subtitle.available': '{count} 个可用',
  'settings.integrations.page.subtitle.sourcesOnline': '{count} 个来源在线',
  'settings.integrations.page.subtitle.cached': '{count} 个已缓存',
  'settings.integrations.page.searchPlaceholder': '搜索集成...',
  ...
  'settings.integrations.page.filterPlugins': '插件',
  'settings.integrations.page.categoryAll': '所有分类',
  'settings.integrations.page.categoryFiles': '文件与数据',
  'settings.integrations.page.categoryTools': '工具',
  'settings.integrations.page.categoryChat': '聊天与语音',
  'settings.integrations.page.categoryAgents': '代理',
  'settings.integrations.page.categoryServices': '服务',
  'settings.integrations.page.loading': '加载集成中...',
  'settings.integrations.page.empty': '未找到集成',
  'settings.integrations.page.emptyHint': '请尝试其他搜索或筛选',
  'settings.integrations.card.skill': '技能',
  'settings.integrations.card.mcp': 'MCP',
  'settings.integrations.card.plugin': '插件',
  'settings.integrations.card.official': '官方',
  'settings.integrations.card.installed': '已安装',
  'settings.integrations.detail.about': '关于',
  'settings.integrations.detail.howToInstall': '如何安装',
  'settings.integrations.detail.requiredCredentials': '所需凭证',
  'settings.integrations.detail.required': '必需',
  'settings.integrations.detail.details': '详情',
  'settings.integrations.detail.source': '来源',
  'settings.integrations.detail.author': '作者',
  'settings.integrations.detail.version': '版本',
  'settings.integrations.detail.category': '分类',
  'settings.integrations.detail.tags': '标签',
  'settings.integrations.detail.documentation': '文档',
  'settings.integrations.detail.install': '安装',
