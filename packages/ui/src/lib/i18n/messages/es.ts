...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala Glenker para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "Glenker se instaló",
  ...
  "sessions.sidebar.footer.actions.aboutGlenker": "Acerca de Glenker",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a Glenker: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener Glenker",
  ...
  "aboutDialog.glenkerVersionLabel": "Versión de Glenker {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de Glenker, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por Glenker de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de Glenker",
  "header.actions.openAppMenuAria": "Abrir menú de Glenker",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de Glenker",
  ...
  "multiRun.window.description": "Ventana de Glenker Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a Glenker",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si Glenker no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de Glenker. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de Glenker y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de Glenker para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor Glenker o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de Glenker. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta Glenker pero no es compatible con esta versión de la app. Actualiza Glenker en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando Glenker. Verifica que la dirección apunte a un servidor Glenker.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando Glenker. Verifica que la dirección apunte a un servidor Glenker.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor Glenker en \"{host}\" no es compatible con esta versión de la app. Actualiza Glenker en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "Glenker no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando Glenker...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: glenker update",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén Glenker abierto.",
  ...
  "glenkerUpdate.toast.available.title": "Actualización de Glenker",
  "glenkerUpdate.toast.available.description": "Versión {version} disponible.",
  "glenkerUpdate.toast.actions.download": "Descargar",
  "glenkerUpdate.toast.actions.restart": "Reiniciar",
  "glenkerUpdate.toast.actions.dismiss": "Descartar",
  "glenkerUpdate.toast.downloading.title": "Descargando actualización...",
  "glenkerUpdate.toast.downloading.description": "{progress}% completado",
  "glenkerUpdate.toast.downloaded.title": "Actualización descargada",
  "glenkerUpdate.toast.downloaded.description": "Reinicia para aplicar versión {version}",
  "glenkerUpdate.toast.failed.title": "Error al actualizar",
  "setupWizard.title": "Bienvenido a Glenker",
  ...
  "glenkerLogo.aria.logo": "Logo de Glenker",
