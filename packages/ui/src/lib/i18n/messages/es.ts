...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala OpenJunior para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "OpenJunior se instaló",
  ...
  "sessions.sidebar.footer.actions.aboutOpenJunior": "Acerca de OpenJunior",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a OpenJunior: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "header.services.shutdownDev": "Detener OpenJunior",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de OpenJunior {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OpenJunior, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por OpenJunior de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de OpenJunior",
  "header.actions.openAppMenuAria": "Abrir menú de OpenJunior",
  ...
  "chat.commandAutocomplete.command.goalDescription": "Establece un objetivo que la IA mantendrá presente en todo el trabajo posterior.",
  ...
  "chat.chatInput.toast.goalCleared": "Objetivo eliminado",
  "chat.chatInput.toast.goalNone": "No hay objetivo activo. Establece uno con /goal <tu objetivo>",
  "chat.chatInput.toast.goalFailed": "No se pudo establecer el objetivo",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de OpenJunior",
  ...
  "multiRun.window.description": "Ventana de OpenJunior Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a OpenJunior",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OpenJunior no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de OpenJunior. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OpenJunior y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de OpenJunior para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor OpenJunior o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de OpenJunior. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta OpenJunior pero no es compatible con esta versión de la app. Actualiza OpenJunior en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando OpenJunior. Verifica que la dirección apunte a un servidor OpenJunior.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando OpenJunior. Verifica que la dirección apunte a un servidor OpenJunior.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor OpenJunior en \"{host}\" no es compatible con esta versión de la app. Actualiza OpenJunior en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "OpenJunior no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando OpenJunior...",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén OpenJunior abierto.",
  ...
  "openjuniorUpdate.toast.available.title": "Actualización de OpenJunior",
  "openjuniorUpdate.toast.available.description": "Versión {version} disponible.",
  "openjuniorUpdate.toast.actions.download": "Descargar",
  "openjuniorUpdate.toast.actions.restart": "Reiniciar",
  "openjuniorUpdate.toast.actions.dismiss": "Descartar",
  "openjuniorUpdate.toast.downloading.title": "Descargando actualización...",
  "openjuniorUpdate.toast.downloading.description": "{progress}% completado",
  "openjuniorUpdate.toast.downloaded.title": "Actualización descargada",
  "openjuniorUpdate.toast.downloaded.description": "Reinicia para aplicar versión {version}",
  "openjuniorUpdate.toast.failed.title": "Error al actualizar",
  "setupWizard.title": "Bienvenido a OpenJunior",
  "setupWizard.subtitle": "Te configuraremos en unos pocos pasos",
  "setupWizard.skip": "Saltar",
  "setupWizard.back": "Atrás",
  "setupWizard.next": "Siguiente",
  "setupWizard.finish": "Finalizar",
  "setupWizard.step1.title": "¿Qué quieres hacer?",
  "setupWizard.step1.subtitle": "Elige tu caso de uso principal para configurar la mejor experiencia",
  "setupWizard.useCase.coding": "Escribir y depurar código",
  "setupWizard.useCase.codingDesc": "Asistente de codificación completo con edición de archivos, terminal y git",
  "setupWizard.useCase.writing": "Escribir y documentar",
  "setupWizard.useCase.writingDesc": "Asistente de escritura para docs, blogs y contenido técnico",
  "setupWizard.useCase.research": "Investigar y aprender",
  "setupWizard.useCase.researchDesc": "Búsqueda web, exploración de código y análisis profundo",
  "setupWizard.useCase.automation": "Automatizar tareas",
  "setupWizard.useCase.automationDesc": "Ejecutar scripts, gestionar flujos y automatizar trabajo repetitivo",
  "setupWizard.step2.title": "Conecta tu IA",
  "setupWizard.step2.subtitle": "Elige un proveedor de IA para potenciar tus conversaciones",
  "setupWizard.step2.apiKey": "API Key",
  "setupWizard.step2.apiKeyHint": "Tu clave se guarda localmente y nunca se comparte",
  "setupWizard.step2.apiKeyPlaceholder": "Ingresa tu API key",
  "setupWizard.step2.localInfo": "Los modelos locales corren en tu máquina vía Ollama. Configúralos en Ajustes → Proveedores.",
  "setupWizard.step3.title": "Elige tu perfil",
  "setupWizard.step3.subtitle": "Selecciona un preset que coincida con tu forma de trabajar",
  "setupWizard.step3.ready": "¡Todo listo! Pulsa Finalizar para empezar.",
  "setupWizard.profile.developer": "Desarrollador",
  "setupWizard.profile.developerDesc": "Ideal para programar, depurar y desarrollo de software",
  "setupWizard.profile.writer": "Escritor",
  "setupWizard.profile.writerDesc": "Ideal para documentación, blogs y escritura técnica",
  "setupWizard.profile.researcher": "Investigador",
  "setupWizard.profile.researcherDesc": "Ideal para investigación profunda, exploración de código y aprendizaje",
  "setupWizard.profile.student": "Estudiante",
  "setupWizard.profile.studentDesc": "Ideal para aprender, tutoría y resolución guiada de problemas",
  ...
  "openChamberLogo.aria.logo": "Logo de OpenJunior",
  ...
  "settings.integrations.page.title": "Integraciones",
  "settings.integrations.page.subtitle.available": "{count} disponibles",
  "settings.integrations.page.subtitle.sourcesOnline": "{count} fuentes en línea",
  "settings.integrations.page.subtitle.cached": "{count} en caché",
  "settings.integrations.page.searchPlaceholder": "Buscar integraciones...",
  ...
  "settings.integrations.page.categoryAll": "Todas las categorías",
  "settings.integrations.page.categoryFiles": "Archivos y datos",
  "settings.integrations.page.categoryTools": "Herramientas",
  "settings.integrations.page.categoryChat": "Chat y voz",
  "settings.integrations.page.categoryAgents": "Agentes",
  "settings.integrations.page.categoryServices": "Servicios",
  "settings.integrations.page.loading": "Cargando integraciones...",
  "settings.integrations.page.empty": "No se encontraron integraciones",
  "settings.integrations.page.emptyHint": "Intenta con otra búsqueda o filtro",
  "settings.integrations.card.skill": "Habilidad",
  ...
  "settings.integrations.detail.about": "Acerca de",
  "settings.integrations.detail.howToInstall": "Cómo instalar",
  "settings.integrations.detail.requiredCredentials": "Credenciales requeridas",
  "settings.integrations.detail.required": "Requerido",
  "settings.integrations.detail.details": "Detalles",
  "settings.integrations.detail.source": "Fuente",
  "settings.integrations.detail.author": "Autor",
  "settings.integrations.detail.version": "Versión",
  "settings.integrations.detail.category": "Categoría",
  "settings.integrations.detail.tags": "Etiquetas",
  "settings.integrations.detail.documentation": "Documentación",
