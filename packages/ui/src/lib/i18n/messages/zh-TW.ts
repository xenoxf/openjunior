...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 Glenker 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'Glenker 已安裝',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 Glenker。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 Glenker，但與此應用程式版本不相容。請更新伺服器上的 Glenker 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 Glenker 伺服器與此應用程式版本不相容。請更新伺服器上的 Glenker 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutGlenker': '關於 Glenker',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 Glenker 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.services.shutdownDev': '停止 Glenker',
  ...
  'aboutDialog.glenkerVersionLabel': 'Glenker 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 Glenker 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 Glenker',
  ...
  'header.actions.openAppMenu': 'Glenker 選單',
  'header.actions.openAppMenuAria': '開啟 Glenker 選單',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 Glenker',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 Glenker 伺服器之間切換',
  ...
  'multiRun.window.description': 'Glenker 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 Glenker',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 Glenker 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 Glenker 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 Glenker 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 Glenker 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 Glenker 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 Glenker。請確認位址是否指向 Glenker 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 Glenker。請確認位址是否指向 Glenker 伺服器。',
  ...
  'startup.initRecovery.description': 'Glenker 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 Glenker...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍等後重新整理，或執行：glenker update',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 Glenker 開啟。',
  ...
  'glenkerLogo.aria.logo': 'Glenker 標誌',
  ...
  'setupWizard.title': '歡迎使用 Glenker',
