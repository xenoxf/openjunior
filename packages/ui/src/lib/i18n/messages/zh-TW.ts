...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '安裝 OpenJunior 以便更快存取',
  'pwa.installPrompt.action': '安裝',
  'pwa.installPrompt.dismiss': '忽略',
  'pwa.installPrompt.started': '已開始安裝',
  'pwa.installPrompt.installed': 'OpenJunior 已安裝',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 OpenJunior。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 OpenJunior，但與此應用程式版本不相容。請更新伺服器上的 OpenJunior 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 OpenJunior 伺服器與此應用程式版本不相容。請更新伺服器上的 OpenJunior 後重試。',
  ...
  'sessions.sidebar.footer.actions.aboutOpenJunior': '關於 OpenJunior',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 OpenJunior 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'header.services.shutdownDev': '停止 OpenJunior',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpenJunior 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpenJunior 狀態、OpenCode 健康資訊、目錄和專案。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 OpenJunior',
  ...
  'header.actions.openAppMenu': 'OpenJunior 選單',
  'header.actions.openAppMenuAria': '開啟 OpenJunior 選單',
  ...
  'chat.commandAutocomplete.command.goalDescription': '設定一個目標，AI 將在所有後續工作中牢記該目標。',
  ...
  'chat.chatInput.toast.goalCleared': '目標已清除',
  'chat.chatInput.toast.goalNone': '沒有活動目標。使用 /goal <你的目標> 設置一個',
  'chat.chatInput.toast.goalFailed': '設定目標失敗',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 OpenJunior',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 OpenJunior 伺服器之間切換',
  ...
  'multiRun.window.description': 'OpenJunior 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 OpenJunior',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpenJunior 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 OpenJunior 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OpenJunior 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 OpenJunior 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 OpenJunior 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 OpenJunior。請確認位址是否指向 OpenJunior 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 OpenJunior。請確認位址是否指向 OpenJunior 伺服器。',
  ...
  'startup.initRecovery.description': 'OpenJunior 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 OpenJunior...',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 OpenJunior 開啟。',
  ...
  'openChamberLogo.aria.logo': 'OpenJunior 標誌',
  ...
  'setupWizard.title': '歡迎使用 OpenJunior',
  'setupWizard.subtitle': '幾個步驟完成設定',
  'setupWizard.skip': '跳過',
  'setupWizard.back': '上一步',
  'setupWizard.next': '下一步',
  'setupWizard.finish': '完成',
  'setupWizard.step1.title': '您想做什麼？',
  'setupWizard.step1.subtitle': '選擇主要使用場景，我們將為您配置最佳體驗',
  'setupWizard.useCase.coding': '撰寫與除錯程式碼',
  'setupWizard.useCase.codingDesc': '完整的程式設計助手，具備檔案編輯、終端機與 Git',
  'setupWizard.useCase.writing': '撰寫與文件化',
  'setupWizard.useCase.writingDesc': '文件、部落格、技術內容的寫作助手',
  'setupWizard.useCase.research': '研究與學習',
  'setupWizard.useCase.researchDesc': '網路搜尋、程式碼探索與深度分析',
  'setupWizard.useCase.automation': '自動化任務',
  'setupWizard.useCase.automationDesc': '執行腳本、管理工作流程、自動化重複性工作',
  'setupWizard.step2.title': '連接您的 AI',
  'setupWizard.step2.subtitle': '選擇 AI 提供商來支援您的對話',
  'setupWizard.step2.apiKey': 'API 金鑰',
  'setupWizard.step2.apiKeyHint': '您的金鑰儲存在本機，不會被分享',
  'setupWizard.step2.apiKeyPlaceholder': '輸入您的 API 金鑰',
  'setupWizard.step2.localInfo': '本地模型透過 Ollama 在您的機器上運行。請在設定 → 提供商中配置。',
  'setupWizard.step3.title': '選擇您的配置檔',
  'setupWizard.step3.subtitle': '選擇符合您工作方式的預設配置',
  'setupWizard.step3.ready': '一切就緒！點擊完成開始使用。',
  'setupWizard.profile.developer': '開發者',
  'setupWizard.profile.developerDesc': '最適合編程、除錯與軟體開發',
  'setupWizard.profile.writer': '寫作者',
  'setupWizard.profile.writerDesc': '最適合文件、部落格與技術寫作',
  'setupWizard.profile.researcher': '研究員',
  'setupWizard.profile.researcherDesc': '最適合深度研究、程式碼探索與學習',
  'setupWizard.profile.student': '學生',
  'setupWizard.profile.studentDesc': '最適合學習、輔導與引導式問題解決',
  'settings.integrations.page.title': '整合',
  'settings.integrations.page.subtitle.available': '{count} 個可用',
  'settings.integrations.page.subtitle.sourcesOnline': '{count} 個來源線上',
  'settings.integrations.page.subtitle.cached': '{count} 個已快取',
  'settings.integrations.page.searchPlaceholder': '搜尋整合...',
  'settings.integrations.page.filterAll': '全部',
  'settings.integrations.page.filterSkills': '技能',
  'settings.integrations.page.filterMCPs': 'MCP',
  'settings.integrations.page.filterPlugins': '外掛',
  'settings.integrations.page.categoryAll': '所有分類',
  'settings.integrations.page.categoryFiles': '檔案與資料',
  'settings.integrations.page.categoryTools': '工具',
  'settings.integrations.page.categoryChat': '聊天與語音',
  'settings.integrations.page.categoryAgents': '代理',
  'settings.integrations.page.categoryServices': '服務',
  'settings.integrations.page.loading': '載入整合中...',
  'settings.integrations.page.empty': '找不到整合',
  'settings.integrations.page.emptyHint': '請嘗試其他搜尋或篩選',
  'settings.integrations.card.skill': '技能',
  'settings.integrations.card.mcp': 'MCP',
  'settings.integrations.card.plugin': '外掛',
  'settings.integrations.card.official': '官方',
  'settings.integrations.card.installed': '已安裝',
  'settings.integrations.detail.about': '關於',
  'settings.integrations.detail.howToInstall': '如何安裝',
  'settings.integrations.detail.requiredCredentials': '所需憑證',
  'settings.integrations.detail.required': '必要',
  'settings.integrations.detail.details': '詳細資料',
  'settings.integrations.detail.source': '來源',
  'settings.integrations.detail.author': '作者',
  'settings.integrations.detail.version': '版本',
  'settings.integrations.detail.category': '分類',
  'settings.integrations.detail.tags': '標籤',
  'settings.integrations.detail.documentation': '文件',
  'settings.integrations.detail.install': '安裝',
  'settings.integrations.detail.installing': '安裝中...',
  'settings.integrations.toast.installed': '{name} 安裝成功',
  'settings.integrations.toast.installFailed': '安裝失敗',
  'settings.integrations.card.popular': '🔥 熱門',
  'settings.integrations.card.noDescription': '無可用描述',
  'settings.integrations.detail.signInWithGoogle': '使用 Google 登入',
  'settings.integrations.detail.signInWithGoogleDescription': '連接您的 Google 帳戶以啟用此 MCP 伺服器。您的憑證會儲存在本地。',
  'settings.integrations.detail.googleOAuthNote': '此 Google 整合使用 OAuth。點擊下方按鈕進行授權。',
  'settings.integrations.detail.installType': '安裝類型',
  'settings.integrations.detail.transport': '傳輸方式',
} as const;
