export const settingsDict = {
  ...
  'settings.window.description': 'Glenker settings window.',
  ...
  'settings.glenker.tunnel.title': 'Remote Tunnel',
  'settings.glenker.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.glenker.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.glenker.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.glenker.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.glenker.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.glenker.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.glenker.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.glenker.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.glenker.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.glenker.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.glenker.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.glenker.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.glenker.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.glenker.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.glenker.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.glenker.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.glenker.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.glenker.tunnel.field.provider': 'Provider',
  'settings.glenker.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.glenker.tunnel.field.tunnelType': 'Tunnel type',
  'settings.glenker.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.glenker.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.glenker.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.glenker.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.glenker.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.glenker.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.glenker.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.glenker.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.glenker.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.glenker.tunnel.field.configurationFile': 'Configuration file',
  'settings.glenker.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.glenker.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.glenker.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.glenker.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.glenker.tunnel.field.connectLink': 'Connect link',
  'settings.glenker.tunnel.field.expires': 'Expires',
  'settings.glenker.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.glenker.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.glenker.tunnel.actions.saveToken': 'Save token',
  'settings.glenker.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.glenker.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.glenker.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.glenker.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.glenker.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.glenker.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.glenker.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.glenker.tunnel.actions.stopping': 'Stopping...',
  'settings.glenker.tunnel.actions.newConnectLink': 'New connect link',
  'settings.glenker.tunnel.actions.copied': 'Copied',
  'settings.glenker.tunnel.actions.retry': 'Retry',
  'settings.glenker.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.glenker.tunnel.option.mode.quick.label': 'Quick',
  'settings.glenker.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.glenker.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.glenker.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.glenker.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.glenker.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.glenker.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.glenker.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.glenker.tunnel.state.loading': 'Loading',
  'settings.glenker.tunnel.state.expired': 'Expired',
  'settings.glenker.tunnel.state.revoked': 'Revoked',
  'settings.glenker.tunnel.state.inactive': 'Inactive',
  'settings.glenker.tunnel.state.noExpiry': 'No expiry',
  'settings.glenker.tunnel.state.never': 'Never',
  'settings.glenker.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.glenker.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.glenker.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.glenker.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.glenker.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.glenker.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/glenker/cloudflare-managed-remote-tunnels.json.',
  'settings.glenker.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.glenker.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.glenker.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.glenker.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.glenker.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.glenker.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.glenker.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.glenker.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.glenker.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.glenker.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.glenker.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.glenker.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.glenker.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.glenker.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.glenker.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.glenker.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.glenker.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.glenker.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.glenker.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.glenker.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.glenker.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.glenker.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.glenker.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.glenker.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.glenker.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.glenker.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other Glenker servers',
  'settings.remoteInstances.direct.description': 'Add another Glenker server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another Glenker server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid Glenker connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so Glenker Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether Glenker should start the server for you, or connect to one that is already running.',
  ...
  'settings.glenker.about.title': 'About Glenker',
  'settings.glenker.about.field.version': 'Version',
  'settings.glenker.about.field.openCodeVersion': 'OpenCode version',
  'settings.glenker.about.state.checking': 'Checking...',
  'settings.glenker.about.state.upToDate': 'Up to date',
  'settings.glenker.about.state.unknown': 'unknown',
  'settings.glenker.about.actions.checkUpdates': 'Check updates',
  'settings.glenker.about.actions.update': 'Update',
  'settings.glenker.about.actions.updateToVersion': 'Update to {version}',
  'settings.glenker.about.actions.checkForUpdates': 'Check for updates',
  'settings.glenker.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. Glenker will scan it for folders containing',
  ...
  'settings.glenker.passkeys.title': 'Passkeys',
  'settings.glenker.passkeys.field.currentDevice': 'Current device',
  'settings.glenker.passkeys.actions.add': 'Add passkey',
  'settings.glenker.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.glenker.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.glenker.passkeys.actions.signingOut': 'Signing out…',
  'settings.glenker.passkeys.actions.removing': 'Removing…',
  'settings.glenker.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.glenker.passkeys.state.loading': 'Loading passkeys…',
  'settings.glenker.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.glenker.passkeys.item.lastUsed': 'Last used {time}',
  'settings.glenker.passkeys.item.added': 'Added {time}',
  'settings.glenker.passkeys.time.neverUsed': 'Never used',
  'settings.glenker.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.glenker.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.glenker.passkeys.toast.added': 'Passkey added',
  'settings.glenker.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.glenker.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.glenker.passkeys.toast.removed': 'Passkey removed',
  'settings.glenker.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.glenker.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.glenker.sessionRetention.title': 'Session Retention',
  'settings.glenker.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.glenker.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.glenker.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.glenker.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.glenker.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.glenker.sessionRetention.field.days': 'days',
  'settings.glenker.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.glenker.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.glenker.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.glenker.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.glenker.sessionRetention.action.archive': 'Archive',
  'settings.glenker.sessionRetention.action.delete': 'Delete',
  'settings.glenker.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.glenker.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.glenker.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.glenker.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.glenker.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.glenker.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.glenker.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.glenker.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.glenker.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.glenker.desktopNetwork.title': 'Desktop Network Access',
  'settings.glenker.desktopNetwork.field.launchAtLoginAria': 'Start Glenker at login',
  'settings.glenker.desktopNetwork.field.launchAtLogin': 'Start Glenker when you log in',
  'settings.glenker.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
  'settings.glenker.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.glenker.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.glenker.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.glenker.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.glenker.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.glenker.desktopPassword.field.password': 'Desktop UI Password',
  'settings.glenker.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.glenker.desktopPassword.field.passwordDescription': 'Glenker asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.glenker.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.glenker.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.glenker.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.glenker.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.glenker.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.glenker.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.glenker.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.glenker.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.glenker.opencodeCli.title': 'OpenCode CLI',
  'settings.glenker.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.glenker.opencodeCli.tooltipSuffix': 'binary.',
  'settings.glenker.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.glenker.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.glenker.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.glenker.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.glenker.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.glenker.opencodeCli.actions.browse': 'Browse',
  'settings.glenker.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.glenker.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.glenker.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.glenker.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.glenker.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.glenker.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.glenker.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.glenker.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.glenker.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.glenker.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.glenker.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.glenker.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.glenker.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.glenker.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.glenker.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.glenker.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.glenker.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.glenker.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.glenker.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.glenker.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.glenker.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.glenker.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.glenker.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.glenker.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.glenker.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.glenker.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.glenker.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.glenker.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.glenker.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.glenker.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.glenker.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.glenker.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.glenker.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.glenker.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.glenker.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.glenker.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.glenker.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open Glenker there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'Glenker on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how Glenker should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote Glenker server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote Glenker UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How Glenker should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingGlenker': 'Installing Glenker',
  'settings.remoteInstances.page.phase.updatingGlenker': 'Updating Glenker',
  ...
  'settings.glenker.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.glenker.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.glenker.worktrees.setup.title': 'Setup commands',
  'settings.glenker.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.glenker.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.glenker.worktrees.setup.loading': 'Loading...',
  'settings.glenker.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.glenker.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.glenker.worktrees.setup.addCommand': 'Add command',
  'settings.glenker.worktrees.list.title': 'Existing worktrees',
  'settings.glenker.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.glenker.worktrees.list.loading': 'Loading worktrees...',
  'settings.glenker.worktrees.list.empty': 'No worktrees found for this project',
  'settings.glenker.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.glenker.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by Glenker.',
  ...
  'settings.glenker.defaults.title': 'Session Defaults',
  'settings.glenker.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.glenker.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.glenker.defaults.field.defaultModel': 'Default Model',
  'settings.glenker.defaults.field.defaultThinking': 'Default Thinking',
  'settings.glenker.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.glenker.defaults.field.defaultAgent': 'Default Agent',
  'settings.glenker.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.glenker.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.glenker.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.glenker.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.glenker.defaults.option.default': 'Default',
  'settings.glenker.defaults.option.defaultLowercase': 'default',
  'settings.glenker.git.title': 'Git Preferences',
  'settings.glenker.git.changesViewTitle': 'Changes View',
  'settings.glenker.git.changesViewAria': 'Git changes view mode',
  'settings.glenker.git.option.flatList': 'Flat List',
  'settings.glenker.git.option.treeView': 'Tree View',
  'settings.glenker.git.optionAria': 'Git changes view mode: {option}',
  'settings.glenker.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.glenker.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.glenker.git.showGitignoredAria': 'Display gitignored files',
  'settings.glenker.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize Glenker',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if Glenker auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from Glenker.',
  ...
  'settings.glenker.visual.section.colorMode': 'Color Mode',
  'settings.glenker.visual.section.mobileLayout': 'Mobile Layout',
  'settings.glenker.visual.option.mobileLayout.default': 'Old',
  'settings.glenker.visual.option.mobileLayout.new': 'New',
  'settings.glenker.visual.section.localization': 'Localization',
  'settings.glenker.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.glenker.visual.section.navigation': 'Navigation',
  'settings.glenker.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.glenker.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.glenker.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.glenker.visual.section.activityDefault': 'Activity Default',
  'settings.glenker.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.glenker.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.glenker.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.glenker.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.glenker.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.glenker.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.glenker.visual.section.diffLayout': 'Diff Layout',
  'settings.glenker.visual.section.diffLayoutAria': 'Diff layout',
  'settings.glenker.visual.section.privacy': 'Privacy',
  'settings.glenker.visual.field.lightTheme': 'Light Theme',
  'settings.glenker.visual.field.darkTheme': 'Dark Theme',
  'settings.glenker.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.glenker.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.glenker.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.glenker.visual.field.timeFormat': 'Time Format',
  'settings.glenker.visual.field.weekStartsOn': 'Week Starts On',
  'settings.glenker.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.glenker.visual.field.selectWeekStartAria': 'Select week start',
  'settings.glenker.visual.actions.reloadThemes': 'Reload themes',
  'settings.glenker.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.glenker.visual.field.macVibrancy': 'Window transparency',
  'settings.glenker.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.glenker.visual.actions.saveAndRestart': 'Save & restart',
  'settings.glenker.visual.actions.restarting': 'Restarting…',
  'settings.glenker.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.glenker.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/glenker/themes/',
  'settings.glenker.visual.field.installAppName': 'Install App Name',
  'settings.glenker.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.glenker.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.glenker.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.glenker.visual.field.installOrientation': 'Install Orientation',
  'settings.glenker.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.glenker.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.glenker.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.glenker.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.glenker.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.glenker.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.glenker.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.glenker.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.glenker.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.glenker.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.glenker.visual.field.interfaceFont': 'Interface Font',
  'settings.glenker.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.glenker.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.glenker.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.glenker.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.glenker.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.glenker.visual.field.codeFont': 'Code Font',
  'settings.glenker.visual.field.selectCodeFontAria': 'Select code font',
  'settings.glenker.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.glenker.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.glenker.visual.field.spacingDensity': 'Spacing Density',
  'settings.glenker.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.glenker.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.glenker.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.glenker.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.glenker.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.glenker.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.glenker.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.glenker.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.glenker.visual.option.fileEditorKeymap.default': 'Default',
  'settings.glenker.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.glenker.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.glenker.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.glenker.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.glenker.visual.field.bash': 'Bash',
  'settings.glenker.visual.field.editTools': 'Edit tools',
  'settings.glenker.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.glenker.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.glenker.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.glenker.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.glenker.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.glenker.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.glenker.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.glenker.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.glenker.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.glenker.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.glenker.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.glenker.visual.field.expandedEditorToolbarAria': 'Always show editor toolbar',
  'settings.glenker.visual.field.expandedEditorToolbar': 'Always show editor toolbar (docked under the file tabs)',
  'settings.glenker.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.glenker.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.glenker.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.glenker.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.glenker.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.glenker.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.glenker.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.glenker.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.glenker.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.glenker.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.glenker.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.glenker.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.glenker.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.glenker.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.glenker.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.glenker.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.glenker.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.glenker.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.glenker.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.glenker.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.glenker.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.glenker.visual.option.themeMode.system': 'System',
  'settings.glenker.visual.option.themeMode.light': 'Light',
  'settings.glenker.visual.option.themeMode.dark': 'Dark',
  'settings.glenker.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.glenker.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.glenker.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.glenker.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.glenker.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.glenker.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.glenker.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.glenker.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.glenker.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.glenker.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.glenker.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.glenker.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.glenker.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.glenker.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.glenker.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.glenker.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.glenker.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.glenker.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.glenker.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.glenker.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.glenker.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.glenker.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.glenker.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.glenker.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.glenker.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.glenker.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.glenker.visual.option.chatRenderMode.live.label': 'Live',
  'settings.glenker.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.glenker.visual.option.messageTransport.auto.label': 'Auto',
  'settings.glenker.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.glenker.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.glenker.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.glenker.visual.option.messageTransport.sse.label': 'SSE',
  'settings.glenker.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.glenker.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.glenker.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.glenker.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.glenker.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.glenker.visual.option.timeFormat.auto.label': 'Auto',
  'settings.glenker.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.glenker.visual.option.timeFormat.24h.label': '24-hour',
  'settings.glenker.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.glenker.visual.option.timeFormat.12h.label': '12-hour',
  'settings.glenker.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.glenker.visual.option.weekStart.auto.label': 'Auto',
  'settings.glenker.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.glenker.visual.option.weekStart.monday.label': 'Monday',
  'settings.glenker.visual.option.weekStart.sunday.label': 'Sunday',
  ...
  'settings.connectors.integrations.toast.connected': '{app} connected successfully',
  'settings.connectors.integrations.toast.connectFailed': 'Failed to connect {app}',
  'settings.connectors.integrations.toast.disconnected': '{app} disconnected',
  'settings.connectors.integrations.toast.disconnectFailed': 'Failed to disconnect {app}',
  'settings.connectors.integrations.toast.reauthorized': '{app} re-authorized successfully',
  'settings.connectors.integrations.toast.reauthorizeFailed': 'Failed to re-authorize {app}',
  'settings.connectors.integrations.toast.oauthError': 'Connection failed: {error}',
  'settings.connectors.integrations.toast.oauthTimeout': 'Connection timed out. Please try again.',
  'settings.connectors.integrations.toast.oauthCancelled': 'Authorization was cancelled.',
  'settings.connectors.integrations.toast.oauthBlocked': 'Popup blocked. Please allow popups for this site and try again.',
  ...
  'settings.glenker.visual.section.layoutPanels': 'Interface Layout',
  'settings.glenker.visual.field.showTerminalButton': 'Show terminal button',
  'settings.glenker.visual.field.showMiniBrowser': 'Show mini browser button',
  'settings.glenker.visual.field.showMiniChat': 'Show mini chat button',
  'settings.glenker.visual.field.showRightSidebar': 'Show right sidebar button',
} as const;
