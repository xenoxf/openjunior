export const settingsDict = {
  ...
  'settings.openchamber.about.title': 'About OpenJunior',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start OpenJunior at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start OpenJunior when you log in',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpenJunior asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
