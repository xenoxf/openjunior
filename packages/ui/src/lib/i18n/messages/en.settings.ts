export const settingsDict = {
  ...
  'settings.window.description': 'OpenJunior settings window.',
  ...
  'settings.view.advanced.title': 'Advanced',
  ...
  'settings.page.integrations.connected': 'Connected',
  'settings.page.integrations.available': 'Available',
  'settings.page.integrations.successTitle': 'Integration Successful!',
  'settings.page.integrations.successDescription': '{app} has been connected successfully. You can now use it as a tool in your conversations.',
  'settings.page.integrations.successDescriptionGeneric': 'Service has been connected successfully.',
  'settings.page.integrations.successContinue': 'Continue',
  ...
  'settings.openjunior.tunnel.title': 'Remote Tunnel',
  'settings.openjunior.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.openjunior.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.openjunior.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.openjunior.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.openjunior.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.openjunior.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.openjunior.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.openjunior.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.openjunior.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.openjunior.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.openjunior.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.openjunior.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.openjunior.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.openjunior.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.openjunior.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.openjunior.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.openjunior.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.openjunior.tunnel.field.provider': 'Provider',
  'settings.openjunior.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.openjunior.tunnel.field.tunnelType': 'Tunnel type',
  'settings.openjunior.tunnel.field.connectLinkTtl': 'Connect link TTL',
  'settings.openjunior.tunnel.field.tunnelSessionTtl': 'Tunnel session TTL',
  'settings.openjunior.tunnel.field.hostnameLabel': 'Hostname:',
  'settings.openjunior.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.openjunior.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.openjunior.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.openjunior.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.openjunior.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.openjunior.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.openjunior.tunnel.field.configurationFile': 'Configuration file',
  'settings.openjunior.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.openjunior.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.openjunior.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.openjunior.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.openjunior.tunnel.field.connectLink': 'Connect link',
  'settings.openjunior.tunnel.field.expires': 'Expires',
  'settings.openjunior.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.openjunior.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.openjunior.tunnel.actions.saveToken': 'Save token',
  'settings.openjunior.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.openjunior.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.openjunior.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.openjunior.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.openjunior.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.openjunior.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.openjunior.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.openjunior.tunnel.actions.stopping': 'Stopping...',
  'settings.openjunior.tunnel.actions.newConnectLink': 'New connect link',
  'settings.openjunior.tunnel.actions.copied': 'Copied',
  'settings.openjunior.tunnel.actions.retry': 'Retry',
  'settings.openjunior.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.openjunior.tunnel.option.mode.quick.label': 'Quick',
  'settings.openjunior.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.openjunior.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.openjunior.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.openjunior.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.openjunior.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.openjunior.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.openjunior.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.openjunior.tunnel.state.loading': 'Loading',
  'settings.openjunior.tunnel.state.expired': 'Expired',
  'settings.openjunior.tunnel.state.revoked': 'Revoked',
  'settings.openjunior.tunnel.state.inactive': 'Inactive',
  'settings.openjunior.tunnel.state.noExpiry': 'No expiry',
  'settings.openjunior.tunnel.state.never': 'Never',
  'settings.openjunior.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.openjunior.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.openjunior.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.openjunior.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.openjunior.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.openjunior.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/openjunior/cloudflare-managed-remote-tunnels.json.',
  'settings.openjunior.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.openjunior.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.openjunior.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.openjunior.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.openjunior.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.openjunior.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.openjunior.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.openjunior.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.openjunior.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.openjunior.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.openjunior.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.openjunior.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.openjunior.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.openjunior.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.openjunior.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.openjunior.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.openjunior.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.openjunior.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.openjunior.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.openjunior.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.openjunior.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.openjunior.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.openjunior.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.openjunior.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.openjunior.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.openjunior.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other OpenJunior servers',
  'settings.remoteInstances.direct.description': 'Add another OpenJunior server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another OpenJunior server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid OpenJunior connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so OpenJunior Desktop can connect to this server.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether OpenJunior should start the server for you, or connect to one that is already running.',
  ...
  'settings.openjunior.about.title': 'About OpenJunior',
  'settings.openjunior.about.field.version': 'Version',
  'settings.openjunior.about.field.openCodeVersion': 'OpenCode version',
  'settings.openjunior.about.state.checking': 'Checking...',
  'settings.openjunior.about.state.upToDate': 'Up to date',
  'settings.openjunior.about.state.unknown': 'unknown',
  'settings.openjunior.about.actions.checkUpdates': 'Check updates',
  'settings.openjunior.about.actions.update': 'Update',
  'settings.openjunior.about.actions.updateToVersion': 'Update to {version}',
  'settings.openjunior.about.actions.checkForUpdates': 'Check for updates',
  'settings.openjunior.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.page.deleteSkillDialog.title': 'Delete Skill',
  'settings.skills.page.deleteSkillDialog.description': 'Are you sure you want to delete "{name}"? This action cannot be undone.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. OpenJunior will scan it for folders containing',
  ...
  'settings.openjunior.passkeys.title': 'Passkeys',
  'settings.openjunior.passkeys.field.currentDevice': 'Current device',
  'settings.openjunior.passkeys.actions.add': 'Add passkey',
  'settings.openjunior.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.openjunior.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.openjunior.passkeys.actions.signingOut': 'Signing out…',
  'settings.openjunior.passkeys.actions.removing': 'Removing…',
  'settings.openjunior.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.openjunior.passkeys.state.loading': 'Loading passkeys…',
  'settings.openjunior.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.openjunior.passkeys.item.lastUsed': 'Last used {time}',
  'settings.openjunior.passkeys.item.added': 'Added {time}',
  'settings.openjunior.passkeys.time.neverUsed': 'Never used',
  'settings.openjunior.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.openjunior.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.openjunior.passkeys.toast.added': 'Passkey added',
  'settings.openjunior.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.openjunior.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.openjunior.passkeys.toast.removed': 'Passkey removed',
  'settings.openjunior.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.openjunior.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.openjunior.sessionRetention.title': 'Session Retention',
  'settings.openjunior.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.openjunior.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.openjunior.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.openjunior.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.openjunior.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.openjunior.sessionRetention.field.days': 'days',
  'settings.openjunior.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.openjunior.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.openjunior.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.openjunior.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.openjunior.sessionRetention.action.archive': 'Archive',
  'settings.openjunior.sessionRetention.action.delete': 'Delete',
  'settings.openjunior.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.openjunior.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.openjunior.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.openjunior.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.openjunior.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.openjunior.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.openjunior.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.openjunior.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.openjunior.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.openjunior.desktopNetwork.title': 'Desktop Network Access',
  'settings.openjunior.desktopNetwork.field.launchAtLoginAria': 'Start OpenJunior at login',
  'settings.openjunior.desktopNetwork.field.launchAtLogin': 'Start OpenJunior when you log in',
  'settings.openjunior.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Click the Dock icon to open it.',
  'settings.openjunior.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.openjunior.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.openjunior.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.openjunior.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.openjunior.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.openjunior.desktopPassword.field.password': 'Desktop UI Password',
  'settings.openjunior.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.openjunior.desktopPassword.field.passwordDescription': 'OpenJunior asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.openjunior.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.openjunior.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.openjunior.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.openjunior.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.openjunior.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.openjunior.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.openjunior.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.openjunior.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.openjunior.opencodeCli.title': 'OpenCode CLI',
  'settings.openjunior.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.openjunior.opencodeCli.tooltipSuffix': 'binary.',
  'settings.openjunior.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.openjunior.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.openjunior.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.openjunior.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.openjunior.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.openjunior.opencodeCli.actions.browse': 'Browse',
  'settings.openjunior.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.openjunior.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.openjunior.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.openjunior.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.openjunior.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.plugins.page.deleteDialog.title': 'Delete plugin',
  'settings.plugins.page.deleteDialog.description': 'Are you sure you want to delete "{name}"? This action cannot be undone.',
  ...
  'settings.openjunior.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.openjunior.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.openjunior.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.openjunior.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.openjunior.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.openjunior.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.openjunior.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
  'settings.openjunior.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. It is still saved.',
  'settings.openjunior.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.openjunior.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.openjunior.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.openjunior.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.openjunior.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.openjunior.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.openjunior.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
  'settings.openjunior.keyboardShortcuts.action.toggle_right_sidebar.label': 'Toggle right sidebar',
  'settings.openjunior.keyboardShortcuts.action.open_right_sidebar_git.label': 'Open right sidebar Git tab',
  'settings.openjunior.keyboardShortcuts.action.open_right_sidebar_files.label': 'Open right sidebar Files tab',
  'settings.openjunior.keyboardShortcuts.action.cycle_right_sidebar_tab.label': 'Cycle right sidebar tab',
  'settings.openjunior.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.openjunior.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.openjunior.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.openjunior.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.openjunior.keyboardShortcuts.action.toggle_context_plan.label': 'Toggle plan context panel',
  'settings.openjunior.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.openjunior.keyboardShortcuts.action.cycle_services_tab.label': 'Cycle services tab',
  'settings.openjunior.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.openjunior.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.openjunior.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.openjunior.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.openjunior.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.openjunior.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open OpenJunior there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OpenJunior on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how OpenJunior should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Local access',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote OpenJunior server.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote OpenJunior UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How OpenJunior should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.phase.installingOpenJunior': 'Installing OpenJunior',
  'settings.remoteInstances.page.phase.updatingOpenJunior': 'Updating OpenJunior',
  ...
  'settings.openjunior.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.openjunior.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.openjunior.worktrees.setup.title': 'Setup commands',
  'settings.openjunior.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.openjunior.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.openjunior.worktrees.setup.loading': 'Loading...',
  'settings.openjunior.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.openjunior.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.openjunior.worktrees.setup.addCommand': 'Add command',
  'settings.openjunior.worktrees.list.title': 'Existing worktrees',
  'settings.openjunior.worktrees.list.tooltip': 'Worktrees live outside the repo (OpenCode-managed). Deleting a worktree also removes linked sessions.',
  'settings.openjunior.worktrees.list.loading': 'Loading worktrees...',
  'settings.openjunior.worktrees.list.empty': 'No worktrees found for this project',
  'settings.openjunior.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.openjunior.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by OpenJunior.',
  ...
  'settings.openjunior.defaults.title': 'Session Defaults',
  'settings.openjunior.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.openjunior.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.openjunior.defaults.field.defaultModel': 'Default Model',
  'settings.openjunior.defaults.field.defaultThinking': 'Default Thinking',
  'settings.openjunior.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.openjunior.defaults.field.defaultAgent': 'Default Agent',
  'settings.openjunior.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.openjunior.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.openjunior.defaults.field.openFilesPreviewAria': 'Open files in preview mode',
  'settings.openjunior.defaults.field.openFilesPreview': 'Open files in preview mode',
  'settings.openjunior.defaults.option.default': 'Default',
  'settings.openjunior.defaults.option.defaultLowercase': 'default',
  'settings.openjunior.git.title': 'Git Preferences',
  'settings.openjunior.git.changesViewTitle': 'Changes View',
  'settings.openjunior.git.changesViewAria': 'Git changes view mode',
  'settings.openjunior.git.option.flatList': 'Flat List',
  'settings.openjunior.git.option.treeView': 'Tree View',
  'settings.openjunior.git.optionAria': 'Git changes view mode: {option}',
  'settings.openjunior.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.openjunior.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.openjunior.git.showGitignoredAria': 'Display gitignored files',
  'settings.openjunior.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize OpenJunior',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if OpenJunior auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from OpenJunior.',
  ...
  'settings.openjunior.visual.section.colorMode': 'Color Mode',
  'settings.openjunior.visual.section.mobileLayout': 'Mobile Layout',
  'settings.openjunior.visual.option.mobileLayout.default': 'Old',
  'settings.openjunior.visual.option.mobileLayout.new': 'New',
  'settings.openjunior.visual.section.localization': 'Localization',
  'settings.openjunior.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.openjunior.visual.section.navigation': 'Navigation',
  'settings.openjunior.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.openjunior.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.openjunior.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.openjunior.visual.section.activityDefault': 'Activity Default',
  'settings.openjunior.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.openjunior.visual.section.showToolsOpenedByDefault': 'Show tools opened by default:',
  'settings.openjunior.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.openjunior.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.openjunior.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.openjunior.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.openjunior.visual.section.diffLayout': 'Diff Layout',
  'settings.openjunior.visual.section.diffLayoutAria': 'Diff layout',
  'settings.openjunior.visual.section.privacy': 'Privacy',
  'settings.openjunior.visual.field.lightTheme': 'Light Theme',
  'settings.openjunior.visual.field.darkTheme': 'Dark Theme',
  'settings.openjunior.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.openjunior.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.openjunior.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.openjunior.visual.field.timeFormat': 'Time Format',
  'settings.openjunior.visual.field.weekStartsOn': 'Week Starts On',
  'settings.openjunior.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.openjunior.visual.field.selectWeekStartAria': 'Select week start',
  'settings.openjunior.visual.actions.reloadThemes': 'Reload themes',
  'settings.openjunior.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.openjunior.visual.field.macVibrancy': 'Window transparency',
  'settings.openjunior.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
  'settings.openjunior.visual.actions.saveAndRestart': 'Save & restart',
  'settings.openjunior.visual.actions.restarting': 'Restarting…',
  'settings.openjunior.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.openjunior.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/openjunior/themes/',
  'settings.openjunior.visual.field.installAppName': 'Install App Name',
  'settings.openjunior.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.openjunior.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.openjunior.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.openjunior.visual.field.installOrientation': 'Install Orientation',
  'settings.openjunior.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.openjunior.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.openjunior.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.openjunior.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.openjunior.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.openjunior.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.openjunior.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.openjunior.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.openjunior.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.openjunior.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.openjunior.visual.field.interfaceFont': 'Interface Font',
  'settings.openjunior.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.openjunior.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.openjunior.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.openjunior.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.openjunior.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.openjunior.visual.field.codeFont': 'Code Font',
  'settings.openjunior.visual.field.selectCodeFontAria': 'Select code font',
  'settings.openjunior.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.openjunior.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.openjunior.visual.field.spacingDensity': 'Spacing Density',
  'settings.openjunior.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.openjunior.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.openjunior.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.openjunior.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.openjunior.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.openjunior.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.openjunior.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.openjunior.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.openjunior.visual.option.fileEditorKeymap.default': 'Default',
  'settings.openjunior.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.openjunior.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.openjunior.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.openjunior.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.openjunior.visual.field.bash': 'Bash',
  'settings.openjunior.visual.field.editTools': 'Edit tools',
  'settings.openjunior.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  'settings.openjunior.visual.field.mermaidRenderingAria': 'Mermaid rendering: {option}',
  'settings.openjunior.visual.field.diffLayoutAria': 'Diff layout: {option}',
  'settings.openjunior.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.openjunior.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.openjunior.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.openjunior.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.openjunior.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.openjunior.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.openjunior.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.openjunior.visual.field.stickyUserHeader': 'Sticky User Header',
  'settings.openjunior.visual.field.expandedEditorToolbarAria': 'Always show editor toolbar',
  'settings.openjunior.visual.field.expandedEditorToolbar': 'Always show editor toolbar (docked under the file tabs)',
  'settings.openjunior.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.openjunior.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.openjunior.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.openjunior.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.openjunior.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.openjunior.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.openjunior.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.openjunior.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.openjunior.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.openjunior.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.openjunior.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.openjunior.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.openjunior.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.openjunior.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.openjunior.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.openjunior.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.openjunior.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.openjunior.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.openjunior.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.openjunior.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.openjunior.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.openjunior.visual.option.themeMode.system': 'System',
  'settings.openjunior.visual.option.themeMode.light': 'Light',
  'settings.openjunior.visual.option.themeMode.dark': 'Dark',
  'settings.openjunior.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.openjunior.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.openjunior.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.openjunior.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.openjunior.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.openjunior.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.openjunior.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.openjunior.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.openjunior.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.openjunior.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.openjunior.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.openjunior.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.openjunior.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.openjunior.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.openjunior.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.openjunior.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.openjunior.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.openjunior.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.openjunior.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.openjunior.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.openjunior.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.openjunior.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.openjunior.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.openjunior.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.openjunior.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.openjunior.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.openjunior.visual.option.chatRenderMode.live.label': 'Live',
  'settings.openjunior.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.openjunior.visual.option.messageTransport.auto.label': 'Auto',
  'settings.openjunior.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.openjunior.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.openjunior.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.openjunior.visual.option.messageTransport.sse.label': 'SSE',
  'settings.openjunior.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.openjunior.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.openjunior.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.openjunior.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.openjunior.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.openjunior.visual.option.timeFormat.auto.label': 'Auto',
  'settings.openjunior.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.openjunior.visual.option.timeFormat.24h.label': '24-hour',
  'settings.openjunior.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.openjunior.visual.option.timeFormat.12h.label': '12-hour',
  'settings.openjunior.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.openjunior.visual.option.weekStart.auto.label': 'Auto',
  'settings.openjunior.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.openjunior.visual.option.weekStart.monday.label': 'Monday',
  'settings.openjunior.visual.option.weekStart.sunday.label': 'Sunday',
  ...
  'settings.connectors.integrations.searchPlaceholder': 'Search integrations…',
  'settings.connectors.integrations.noResults': 'No results for "{query}"',
  'settings.connectors.integrations.composio.description': 'Connect your accounts (Slack, GitHub, Linear, etc.) to enable AI-powered automation.',
  'settings.connectors.integrations.composio.connect': 'Connect',
  'settings.connectors.integrations.composio.connected': 'Connected',
  'settings.connectors.integrations.composio.disconnect': 'Disconnect',
  'settings.connectors.integrations.composio.disconnecting': 'Disconnecting...',
  'settings.connectors.integrations.composio.connecting': 'Connecting...',
  'settings.connectors.integrations.composio.completeAuth': 'Complete authentication in the opened window.',
  'settings.connectors.integrations.composio.connectFailed': 'Failed to connect',
  'settings.connectors.integrations.composio.disconnectFailed': 'Failed to disconnect',
  'settings.connectors.integrations.composio.disconnected': 'Disconnected',
  'settings.connectors.integrations.composio.tools': 'Tools',
  'settings.connectors.integrations.composio.details': 'Connection Details',
  'settings.connectors.integrations.composio.authScheme': 'Auth Scheme',
  'settings.connectors.integrations.composio.connectedAt': 'Connected',
  'settings.connectors.integrations.composio.reAuthorize': 'Re-authorize',
  ...
  'settings.integrations.page.subtitle.sourcesOnline': '{count} sources online',
  'settings.integrations.page.subtitle.cached': '{count} cached',
  'settings.integrations.page.searchPlaceholder': 'Search integrations...',
  'settings.integrations.page.filterAll': 'All',
  'settings.integrations.page.filterSkills': 'Skills',
  'settings.integrations.page.filterMCPs': 'MCPs',
  'settings.integrations.page.filterPlugins': 'Plugins',
  'settings.integrations.page.categoryAll': 'All Categories',
  'settings.integrations.page.categoryFiles': 'Files & Data',
  'settings.integrations.page.categoryTools': 'Tools',
  'settings.integrations.page.categoryChat': 'Chat & Voice',
  'settings.integrations.page.categoryAgents': 'Agents',
  'settings.integrations.page.categoryServices': 'Services',
  'settings.integrations.page.loading': 'Loading integrations...',
  'settings.integrations.page.empty': 'No integrations found',
  'settings.integrations.page.emptyHint': 'Try a different search or filter',
  'settings.integrations.card.skill': 'Skill',
  'settings.integrations.card.mcp': 'MCP',
  'settings.integrations.card.plugin': 'Plugin',
  'settings.integrations.card.official': 'Official',
  'settings.integrations.card.installed': 'Installed',
  'settings.integrations.detail.about': 'About',
  'settings.integrations.detail.howToInstall': 'How to install',
  'settings.integrations.detail.requiredCredentials': 'Required credentials',
  'settings.integrations.detail.required': 'Required',
  'settings.integrations.detail.details': 'Details',
  'settings.integrations.detail.source': 'Source',
  'settings.integrations.detail.author': 'Author',
  'settings.integrations.detail.version': 'Version',
  'settings.integrations.detail.category': 'Category',
  'settings.integrations.detail.tags': 'Tags',
  'settings.integrations.detail.documentation': 'Documentation',
  'settings.integrations.detail.install': 'Install',
  ...
  'settings.integrations.card.noDescription': 'No description available',
  'settings.integrations.detail.signInWithGoogle': 'Sign in with Google',
  'settings.integrations.detail.signInWithGoogleDescription': 'Connect your Google account to enable this MCP server. Your credentials are stored locally.',
  'settings.integrations.detail.googleOAuthNote': 'This Google integration uses OAuth. Click the button below to authorize.',
  'settings.integrations.detail.installType': 'Install type',
