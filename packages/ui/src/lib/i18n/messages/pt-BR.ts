...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o Glenker para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "Glenker instalado",
  ...
  "sessions.sidebar.footer.actions.aboutGlenker": "Sobre o Glenker",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao Glenker — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar Glenker",
  ...
  "aboutDialog.glenkerVersionLabel": "Versão do Glenker {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do Glenker, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo Glenker com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do Glenker",
  "header.actions.openAppMenuAria": "Abrir menu do Glenker",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear Glenker",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do Glenker",
  ...
  "multiRun.window.description": "Janela do Glenker Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao Glenker",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o Glenker não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do Glenker. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do Glenker e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do Glenker para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor Glenker ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do Glenker. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando Glenker, mas não é compatível com esta versão do app. Atualize o Glenker no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando Glenker. Verifique se o endereço aponta para um servidor Glenker.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando Glenker. Verifique se o endereço aponta para um servidor Glenker.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor Glenker em \"{host}\" não é compatível com esta versão do app. Atualize o Glenker no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O Glenker não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando Glenker...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: glenker update",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o Glenker aberto.",
  ...
  "glenkerLogo.aria.logo": "Logo do Glenker",
  ...
  "setupWizard.title": "Bem-vindo ao Glenker",
