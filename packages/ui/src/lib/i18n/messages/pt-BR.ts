...
export const dict: Record<I18nKey, string> = {
 ...settingsDict,
  ...
  "pwa.installPrompt.description": "Instale o OpenJunior para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "OpenJunior instalado",
  ...
  "sessions.sidebar.footer.actions.aboutOpenJunior": "Sobre o OpenJunior",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao OpenJunior — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "header.services.shutdownDev": "Parar OpenJunior",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do OpenJunior {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OpenJunior, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo OpenJunior com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do OpenJunior",
  "header.actions.openAppMenuAria": "Abrir menu do OpenJunior",
  ...
  "chat.commandAutocomplete.command.goalDescription": "Defina um objetivo que a IA manterá em mente para todo o trabalho subsequente.",
  ...
  "chat.chatInput.toast.goalCleared": "Objetivo limpo",
  "chat.chatInput.toast.goalNone": "Nenhum objetivo ativo. Defina um com /goal <seu objetivo>",
  "chat.chatInput.toast.goalFailed": "Falha ao definir objetivo",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear OpenJunior",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do OpenJunior",
  ...
  "multiRun.window.description": "Janela do OpenJunior Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao OpenJunior",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OpenJunior não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do OpenJunior. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OpenJunior e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do OpenJunior para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor OpenJunior ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do OpenJunior. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando OpenJunior, mas não é compatível com esta versão do app. Atualize o OpenJunior no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando OpenJunior. Verifique se o endereço aponta para um servidor OpenJunior.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando OpenJunior. Verifique se o endereço aponta para um servidor OpenJunior.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor OpenJunior em \"{host}\" não é compatível com esta versão do app. Atualize o OpenJunior no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O OpenJunior não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando OpenJunior...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: openjunior update",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o OpenJunior aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do OpenJunior",
  ...
  "setupWizard.title": "Bem-vindo ao OpenJunior",
  "setupWizard.subtitle": "Vamos configurar você em alguns passos",
  "setupWizard.skip": "Pular",
  "setupWizard.back": "Voltar",
  "setupWizard.next": "Próximo",
  "setupWizard.finish": "Finalizar",
  "setupWizard.step1.title": "O que você quer fazer?",
  "setupWizard.step1.subtitle": "Escolha seu caso de uso principal para configurarmos a melhor experiência",
  "setupWizard.useCase.coding": "Escrever e depurar código",
  "setupWizard.useCase.codingDesc": "Assistente de codificação completo com edição de arquivos, terminal e git",
  "setupWizard.useCase.writing": "Escrever e documentar",
  "setupWizard.useCase.writingDesc": "Assistente de escrita para docs, blogs e conteúdo técnico",
  "setupWizard.useCase.research": "Pesquisar e aprender",
  "setupWizard.useCase.researchDesc": "Busca web, exploração de código e análise profunda",
  "setupWizard.useCase.automation": "Automatizar tarefas",
  "setupWizard.useCase.automationDesc": "Executar scripts, gerenciar fluxos de trabalho e automatizar trabalho repetitivo",
  "setupWizard.step2.title": "Conecte sua IA",
  "setupWizard.step2.subtitle": "Escolha um provedor de IA para alimentar suas conversas",
  "setupWizard.step2.apiKey": "API Key",
  "setupWizard.step2.apiKeyHint": "Sua chave é armazenada localmente e nunca compartilhada",
  "setupWizard.step2.apiKeyPlaceholder": "Digite sua API key",
  "setupWizard.step2.localInfo": "Modelos locais rodam na sua máquina via Ollama. Configure em Ajustes → Provedores.",
  "setupWizard.step3.title": "Escolha seu perfil",
  "setupWizard.step3.subtitle": "Selecione um preset que combine com seu jeito de trabalhar",
  "setupWizard.step3.ready": "Tudo pronto! Clique em Finalizar para começar.",
  "setupWizard.profile.developer": "Desenvolvedor",
  "setupWizard.profile.developerDesc": "Ideal para programar, depurar e desenvolvimento de software",
  "setupWizard.profile.writer": "Escritor",
  "setupWizard.profile.writerDesc": "Ideal para documentação, blogs e escrita técnica",
  "setupWizard.profile.researcher": "Pesquisador",
  "setupWizard.profile.researcherDesc": "Ideal para pesquisa profunda, exploração de código e aprendizado",
  "setupWizard.profile.student": "Estudante",
  "setupWizard.profile.studentDesc": "Ideal para aprender, tutoria e resolução guiada de problemas",
  "settings.integrations.page.title": "Integrações",
  "settings.integrations.page.subtitle.available": "{count} disponíveis",
  "settings.integrations.page.subtitle.sourcesOnline": "{count} fontes online",
  "settings.integrations.page.subtitle.cached": "{count} em cache",
  "settings.integrations.page.searchPlaceholder": "Buscar integrações...",
  "settings.integrations.page.filterAll": "Todas",
  "settings.integrations.page.filterSkills": "Habilidades",
  "settings.integrations.page.filterMCPs": "MCPs",
  "settings.integrations.page.filterPlugins": "Plugins",
  "settings.integrations.page.categoryAll": "Todas as categorias",
  "settings.integrations.page.categoryFiles": "Arquivos e dados",
  "settings.integrations.page.categoryTools": "Ferramentas",
  "settings.integrations.page.categoryChat": "Chat e voz",
  "settings.integrations.page.categoryAgents": "Agentes",
  "settings.integrations.page.categoryServices": "Serviços",
  "settings.integrations.page.loading": "Carregando integrações...",
  "settings.integrations.page.empty": "Nenhuma integração encontrada",
  "settings.integrations.page.emptyHint": "Tente uma busca ou filtro diferente",
  "settings.integrations.card.skill": "Habilidade",
  "settings.integrations.card.mcp": "MCP",
  "settings.integrations.card.plugin": "Plugin",
  "settings.integrations.card.official": "Oficial",
  "settings.integrations.card.installed": "Instalado",
  "settings.integrations.detail.about": "Sobre",
  "settings.integrations.detail.howToInstall": "Como instalar",
  "settings.integrations.detail.requiredCredentials": "Credenciais necessárias",
  "settings.integrations.detail.required": "Obrigatório",
  "settings.integrations.detail.details": "Detalhes",
  "settings.integrations.detail.source": "Fonte",
  "settings.integrations.detail.author": "Autor",
  "settings.integrations.detail.version": "Versão",
  "settings.integrations.detail.category": "Categoria",
  "settings.integrations.detail.tags": "Tags",
  "settings.integrations.detail.documentation": "Documentação",
  "settings.integrations.detail.install": "Instalar",
  "settings.integrations.detail.installing": "Instalando...",
  "settings.integrations.toast.installed": "{name} instalado com sucesso",
  "settings.integrations.toast.installFailed": "Falha na instalação",
  "settings.integrations.card.popular": "🔥 Popular",
  "settings.integrations.card.noDescription": "Nenhuma descrição disponível",
  "settings.integrations.detail.signInWithGoogle": "Entrar com Google",
  "settings.integrations.detail.signInWithGoogleDescription": "Conecte sua conta do Google para ativar este servidor MCP. Suas credenciais são armazenadas localmente.",
  "settings.integrations.detail.googleOAuthNote": "Esta integração do Google usa OAuth. Clique no botão abaixo para autorizar.",
  "settings.integrations.detail.installType": "Tipo de instalação",
