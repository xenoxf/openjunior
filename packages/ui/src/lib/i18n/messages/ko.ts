...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 Glenker를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'Glenker가 설치되었습니다',
  ...
  'sessions.sidebar.footer.actions.aboutGlenker': 'Glenker 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 Glenker에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'Glenker 종료',
  ...
  'aboutDialog.glenkerVersionLabel': 'Glenker 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Glenker 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 Glenker를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'Glenker 메뉴',
  'header.actions.openAppMenuAria': 'Glenker 메뉴 열기',
  ...
  'sessionAuth.locked.unlockTitle': 'Glenker 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 Glenker 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'Glenker 멀티런 창.',
  ...
  'onboarding.chooser.title': 'Glenker에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Glenker가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 Glenker의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Glenker 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 Glenker 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 Glenker 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 Glenker 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 Glenker가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 Glenker를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 Glenker가 실행 중이 아닙니다. 주소가 Glenker 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 Glenker가 실행 중이 아닙니다. 주소가 Glenker 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 Glenker 서버가 이 앱 버전과 호환되지 않습니다. 서버의 Glenker를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'Glenker 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'Glenker 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `glenker update`를 실행하세요.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Glenker를 열어 두세요.',
  ...
  'setupWizard.title': 'Glenker에 오신 것을 환영합니다',
  ...
  'glenkerLogo.aria.logo': 'Glenker 로고',
