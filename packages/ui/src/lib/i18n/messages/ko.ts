...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 OpenJunior를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'OpenJunior가 설치되었습니다',
  ...
  'sessions.sidebar.footer.actions.aboutOpenJunior': 'OpenJunior 정보',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 OpenJunior에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'header.services.shutdownDev': 'OpenJunior 종료',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpenJunior 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'OpenJunior 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'helpDialog.description': '이 단축키로 OpenJunior를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'OpenJunior 메뉴',
  'header.actions.openAppMenuAria': 'OpenJunior 메뉴 열기',
  ...
  'chat.commandAutocomplete.command.goalDescription': 'AI가 모든 후속 작업에서 최우선으로 유지할 목표를 설정합니다.',
  ...
  'chat.chatInput.toast.goalCleared': '목표가 지워졌습니다',
  'chat.chatInput.toast.goalNone': '활성 목표가 없습니다. /goal <목표>로 설정하세요',
  'chat.chatInput.toast.goalFailed': '목표 설정 실패',
  ...
  'sessionAuth.locked.unlockTitle': 'OpenJunior 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 OpenJunior 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'OpenJunior 멀티런 창.',
  ...
  'onboarding.chooser.title': 'OpenJunior에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OpenJunior가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 OpenJunior의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OpenJunior 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 OpenJunior 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 OpenJunior 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 OpenJunior 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 OpenJunior가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 OpenJunior를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 OpenJunior가 실행 중이 아닙니다. 주소가 OpenJunior 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 OpenJunior가 실행 중이 아닙니다. 주소가 OpenJunior 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 OpenJunior 서버가 이 앱 버전과 호환되지 않습니다. 서버의 OpenJunior를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'OpenJunior 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'OpenJunior 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 새로고침하거나 `openjunior update`를 실행하세요.',
  ...
  'opencodeUpdate.toast.upgrading.description': 'OpenJunior를 열어 두세요.',
  ...
  'setupWizard.title': 'OpenJunior에 오신 것을 환영합니다',
  'setupWizard.subtitle': '몇 단계만 거치면 설정 완료',
  'setupWizard.skip': '건너뛰기',
  'setupWizard.back': '뒤로',
  'setupWizard.next': '다음',
  'setupWizard.finish': '완료',
  'setupWizard.step1.title': '무엇을 원하시는 작업은 무엇인가요?',
  'setupWizard.step1.subtitle': '주요 사용 사례를 선택하면 최적의 경험을 제공해 드립니다',
  'setupWizard.useCase.coding': '코드 작성 및 디버깅',
  'setupWizard.useCase.codingDesc': '파일 편집, 터미널, Git을 갖춘 완전한 코딩 어시스턴트',
  'setupWizard.useCase.writing': '글쓰기 및 문서화',
  'setupWizard.useCase.writingDesc': '문서, 블로그, 기술 콘텐츠 작성을 위한 어시스턴트',
  'setupWizard.useCase.research': '조사 및 학습',
  'setupWizard.useCase.researchDesc': '웹 검색, 코드 탐색, 심층 분석',
  'setupWizard.useCase.automation': '작업 자동화',
  'setupWizard.useCase.automationDesc': '스크립트 실행, 워크플로 관리, 반복 작업 자동화',
  'setupWizard.step2.title': 'AI 연결하기',
  'setupWizard.step2.subtitle': '대화를 지원할 AI 제공업체 선택',
  'setupWizard.step2.apiKey': 'API 키',
  'setupWizard.step2.apiKeyHint': '키는 로컬에 저장되며 절대 공유되지 않습니다',
  'setupWizard.step2.apiKeyPlaceholder': 'API 키 입력',
  'setupWizard.step2.localInfo': '로컬 모델은 Ollama를 통해 내 기계에서 실행됩니다. 설정 → 공급자에서 구성하세요.',
  'setupWizard.step3.title': '프로필 선택',
  'setupWizard.step3.subtitle': '작업 방식에 맞는 프리셋 선택',
  'setupWizard.step3.ready': '준비 완료! 완료를 눌러 시작하세요.',
  'setupWizard.profile.developer': '개발자',
  'setupWizard.profile.developerDesc': '코딩, 디버깅, 소프트웨어 개발에 최적',
  'setupWizard.profile.writer': '작가',
  'setupWizard.profile.writerDesc': '문서화, 블로그, 기술 글쓰기에 최적',
  'setupWizard.profile.researcher': '연구원',
  'setupWizard.profile.researcherDesc': '심층 연구, 코드 탐색, 학습에 최적',
  'setupWizard.profile.student': '학생',
  'setupWizard.profile.studentDesc': '학습, 튜터링, 가이드형 문제 해결에 최적',
  ...
  'openChamberLogo.aria.logo': 'OpenJunior 로고',
  ...
  'settings.integrations.page.title': '통합',
  'settings.integrations.page.subtitle.available': '{count}개 사용 가능',
  'settings.integrations.page.subtitle.sourcesOnline': '{count}개 소스 온라인',
  'settings.integrations.page.subtitle.cached': '{count}개 캐시됨',
  'settings.integrations.page.searchPlaceholder': '통합 검색...',
  'settings.integrations.page.filterAll': '전체',
  'settings.integrations.page.filterSkills': '스킬',
  'settings.integrations.page.filterMCPs': 'MCP',
  'settings.integrations.page.filterPlugins': '플러그인',
  'settings.integrations.page.categoryAll': '모든 카테고리',
  'settings.integrations.page.categoryFiles': '파일 및 데이터',
  'settings.integrations.page.categoryTools': '도구',
  'settings.integrations.page.categoryChat': '채팅 및 음성',
  'settings.integrations.page.categoryAgents': '에이전트',
  'settings.integrations.page.categoryServices': '서비스',
  'settings.integrations.page.loading': '통합 로딩 중...',
  'settings.integrations.page.empty': '통합을 찾을 수 없습니다',
  'settings.integrations.page.emptyHint': '다른 검색이나 필터를 시도해 보세요',
  'settings.integrations.card.skill': '스킬',
  'settings.integrations.card.mcp': 'MCP',
  'settings.integrations.card.plugin': '플러그인',
  'settings.integrations.card.official': '공식',
  'settings.integrations.card.installed': '설치됨',
  'settings.integrations.detail.about': '정보',
  'settings.integrations.detail.howToInstall': '설치 방법',
  'settings.integrations.detail.requiredCredentials': '필수 자격 증명',
  'settings.integrations.detail.required': '필수',
  'settings.integrations.detail.details': '세부정보',
  'settings.integrations.detail.source': '소스',
  'settings.integrations.detail.author': '작성자',
  'settings.integrations.detail.version': '버전',
  'settings.integrations.detail.category': '카테고리',
  'settings.integrations.detail.tags': '태그',
  'settings.integrations.detail.documentation': '문서',
  'settings.integrations.detail.install': '설치',
