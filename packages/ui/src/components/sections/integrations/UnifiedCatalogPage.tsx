      ...
      <div className="flex-shrink-0 border-b border-[var(--interactive-border)] px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="typography-micro text-[var(--surface-mutedForeground)]">
        ...
        <div className="mt-3 flex gap-1 overflow-x-auto pb-1">
          {TYPE_FILTERS.map((filter) => (
            <button
              ...
              className={cn(
                'flex items-center gap-1.5 whitespace-nowrap rounded-lg px-3 py-1.5 typography-micro transition-colors',
        ...
        <div className="mt-2 flex gap-1 overflow-x-auto pb-1">
          {CATEGORY_FILTERS.map((filter) => (
            <button
              ...
              className={cn(
                'whitespace-nowrap rounded-lg px-3 py-1.5 typography-micro transition-colors',
